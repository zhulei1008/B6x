...
/// Timer Source: SysTick INT, CTMR1 INT
...
/// CTMR prescaler and Auto-reload value
    ...
    #if (SYS_CLK == 3)
        #define TMS_CTMR_PSC        (639) // 479=(64MHz/100000 - 1), 10us
    #elif (SYS_CLK == 2)
        #define TMS_CTMR_PSC        (479) // 479=(48MHz/100000 - 1), 10us
    #else
...
// CTMR1 configure as auto-reload and update interrupt
