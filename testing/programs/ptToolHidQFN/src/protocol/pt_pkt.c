...
const struct pkt_desc pt_cmd_desc[] =
{
    ...
    /* Proto: Version */
    { PT_CMD_INFO,     PKT_FIXLEN,           PLEN_CMD_INFO   },
    ...
    { PT_CMD_TRIMVAL,     PKT_VARLEN_CRC,    PLEN_CMD_TRIMVAL   },
    ...
    { PT_CMD_TEST_TRIM,   PKT_FIXLEN,        PLEN_CMD_TEST_TRIM },    
#endif //(PT_TEST_CMD)
...
{
    /* Proto: Version */
    { PT_RSP_INFO,     PKT_VARLEN_CRC,       PLEN_RSP_INFO   },
