...
#define EM_BLE_RXCTECNTL_ADDR   (EM_BASE_ADDR + EM_BLE_RX_CTE_DESC_OFFSET)
#else
#define EM_BLE_RXCTECNTL_ADDR   (0x50004000 + EM_BLE_RX_CTE_DESC_OFFSET)
#endif

#define EM_BLE_RXCTECNTL_INDEX  0x00000000
#define EM_BLE_RXCTECNTL_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxctecntl_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXCTECNTL_ADDR + elt_idx * REG_EM_BLE_RX_CTE_DESC_SIZE);
}

__INLINE__ void em_ble_rxctecntl_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_rxctecntl_pack(int elt_idx, uint8_t rxdone, uint16_t rxnextptr)
{
...
__INLINE__ void em_ble_rxctecntl_unpack(int elt_idx, uint8_t* rxdone, uint16_t* rxnextptr)
{
...
__INLINE__ uint8_t em_ble_rxctecntl_rxdone_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXCTECNTL_ADDR + elt_idx * REG_EM_BLE_RX_CTE_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__INLINE__ void em_ble_rxctecntl_rxdone_setf(int elt_idx, uint8_t rxdone)
{
    ASSERT_ERR((((uint16_t)rxdone << 15) & ~((uint16_t)0x00008000)) == 0);
...
__INLINE__ uint16_t em_ble_rxctecntl_rxnextptr_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXCTECNTL_ADDR + elt_idx * REG_EM_BLE_RX_CTE_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00003FFF)) >> 0);
}

__INLINE__ void em_ble_rxctecntl_rxnextptr_setf(int elt_idx, uint16_t rxnextptr)
{
    ASSERT_ERR((((uint16_t)rxnextptr << 0) & ~((uint16_t)0x00003FFF)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXCTESAMPBUF_ADDR   (EM_BASE_ADDR + 0x04 + EM_BLE_RX_CTE_DESC_OFFSET)
#else
#define EM_BLE_RXCTESAMPBUF_ADDR   (0x50004004 + EM_BLE_RX_CTE_DESC_OFFSET)
#endif
...
__INLINE__ uint16_t em_ble_rxctesampbuf_get(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 81);
    return EM_BLE_RD(EM_BLE_RXCTESAMPBUF_ADDR + elt_idx * REG_EM_BLE_RX_CTE_DESC_SIZE + reg_idx * 2);
}

__INLINE__ void em_ble_rxctesampbuf_set(int elt_idx, int reg_idx, uint16_t value)
{
    ASSERT_ERR(reg_idx <= 81);
...
__INLINE__ void em_ble_rxctesampbuf_pack(int elt_idx, int reg_idx, uint8_t rxq, uint8_t rxi)
{
    ASSERT_ERR(reg_idx <= 81);
...
__INLINE__ void em_ble_rxctesampbuf_unpack(int elt_idx, int reg_idx, uint8_t* rxq, uint8_t* rxi)
{
    ASSERT_ERR(reg_idx <= 81);
...
__INLINE__ uint8_t em_ble_rxctesampbuf_rx_q_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 81);
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXCTESAMPBUF_ADDR + elt_idx * REG_EM_BLE_RX_CTE_DESC_SIZE + reg_idx * 2);
...
__INLINE__ void em_ble_rxctesampbuf_rx_q_setf(int elt_idx, int reg_idx, uint8_t rxq)
{
    ASSERT_ERR(reg_idx <= 81);
    ASSERT_ERR((((uint16_t)rxq << 8) & ~((uint16_t)0x0000FF00)) == 0);
...
__INLINE__ uint8_t em_ble_rxctesampbuf_rx_i_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 81);
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXCTESAMPBUF_ADDR + elt_idx * REG_EM_BLE_RX_CTE_DESC_SIZE + reg_idx * 2);
...
__INLINE__ void em_ble_rxctesampbuf_rx_i_setf(int elt_idx, int reg_idx, uint8_t rxi)
{
    ASSERT_ERR(reg_idx <= 81);
    ASSERT_ERR((((uint16_t)rxi << 0) & ~((uint16_t)0x000000FF)) == 0);
