...
#define EM_BLE_LIST_INFO_ADDR   (EM_BASE_ADDR + EM_BLE_WPAL_OFFSET)
#else
#define EM_BLE_LIST_INFO_ADDR   (0x50004000 + EM_BLE_WPAL_OFFSET)
#endif

#define EM_BLE_LIST_INFO_INDEX  0x00000000
#define EM_BLE_LIST_INFO_RESET  0x00000000

__INLINE__ uint16_t em_ble_list_info_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_LIST_INFO_ADDR + elt_idx * REG_EM_BLE_WPAL_SIZE);
}

__INLINE__ void em_ble_list_info_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_list_info_pack(int elt_idx, uint8_t entryvalid, uint8_t idtype, uint8_t inwl, uint8_t inperadvl)
{
...
__INLINE__ void em_ble_list_info_unpack(int elt_idx, uint8_t* entryvalid, uint8_t* idtype, uint8_t* inwl, uint8_t* inperadvl)
{
...
__INLINE__ uint8_t em_ble_list_info_entry_valid_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_LIST_INFO_ADDR + elt_idx * REG_EM_BLE_WPAL_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__INLINE__ void em_ble_list_info_entry_valid_setf(int elt_idx, uint8_t entryvalid)
{
    ASSERT_ERR((((uint16_t)entryvalid << 15) & ~((uint16_t)0x00008000)) == 0);
...
__INLINE__ uint8_t em_ble_list_info_idtype_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_LIST_INFO_ADDR + elt_idx * REG_EM_BLE_WPAL_SIZE);
    return ((localVal & ((uint16_t)0x00004000)) >> 14);
}

__INLINE__ void em_ble_list_info_idtype_setf(int elt_idx, uint8_t idtype)
{
    ASSERT_ERR((((uint16_t)idtype << 14) & ~((uint16_t)0x00004000)) == 0);
...
__INLINE__ uint8_t em_ble_list_info_in_wl_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_LIST_INFO_ADDR + elt_idx * REG_EM_BLE_WPAL_SIZE);
    return ((localVal & ((uint16_t)0x00000002)) >> 1);
}

__INLINE__ void em_ble_list_info_in_wl_setf(int elt_idx, uint8_t inwl)
{
    ASSERT_ERR((((uint16_t)inwl << 1) & ~((uint16_t)0x00000002)) == 0);
...
__INLINE__ uint8_t em_ble_list_info_in_peradvl_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_LIST_INFO_ADDR + elt_idx * REG_EM_BLE_WPAL_SIZE);
    return ((localVal & ((uint16_t)0x00000001)) >> 0);
}

__INLINE__ void em_ble_list_info_in_peradvl_setf(int elt_idx, uint8_t inperadvl)
{
    ASSERT_ERR((((uint16_t)inperadvl << 0) & ~((uint16_t)0x00000001)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_LIST_BDADDR_ADDR   (EM_BASE_ADDR + 0x02 + EM_BLE_WPAL_OFFSET)
#else
#define EM_BLE_LIST_BDADDR_ADDR   (0x50004002 + EM_BLE_WPAL_OFFSET)
#endif
...
__INLINE__ uint16_t em_ble_list_bdaddr_get(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 2);
    return EM_BLE_RD(EM_BLE_LIST_BDADDR_ADDR + elt_idx * REG_EM_BLE_WPAL_SIZE + reg_idx * 2);
}

__INLINE__ void em_ble_list_bdaddr_set(int elt_idx, int reg_idx, uint16_t value)
{
    ASSERT_ERR(reg_idx <= 2);
...
__INLINE__ uint16_t em_ble_list_bdaddr_lbdaddr_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 2);
...
__INLINE__ void em_ble_list_bdaddr_lbdaddr_setf(int elt_idx, int reg_idx, uint16_t lbdaddr)
{
    ASSERT_ERR(reg_idx <= 2);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_LIST_SID_ADDR   (EM_BASE_ADDR + 0x08 + EM_BLE_WPAL_OFFSET)
#else
#define EM_BLE_LIST_SID_ADDR   (0x50004008 + EM_BLE_WPAL_OFFSET)
#endif

#define EM_BLE_LIST_SID_INDEX  0x00000004
#define EM_BLE_LIST_SID_RESET  0x00000000

__INLINE__ uint16_t em_ble_list_sid_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_LIST_SID_ADDR + elt_idx * REG_EM_BLE_WPAL_SIZE);
}

__INLINE__ void em_ble_list_sid_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_list_sid_lsid_getf(int elt_idx)
{
...
__INLINE__ void em_ble_list_sid_lsid_setf(int elt_idx, uint16_t lsid)
{
