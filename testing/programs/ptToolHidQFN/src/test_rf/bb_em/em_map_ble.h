...
#include "hyble_config.h"

#include <stdint.h>                      // integer
//#include "co_llcp.h"
#include "utils.h"                      // For use of ALIGN4_HI
...
#define EM_BLE_WPAL_OFFSET         ALIGN4_HI(EM_BLE_CS_END)
...
#define EM_BLE_RAL_OFFSET        ALIGN4_HI(EM_BLE_WPAL_END)
...
#define EM_BLE_RX_DESC_OFFSET      ALIGN4_HI(EM_BLE_RAL_END)
 ...
 */
#define EM_BLE_TX_DESC_OFFSET           ALIGN4_HI(EM_BLE_RX_DESC_END)
...
#define EM_BLE_LLCPTXBUF_OFFSET    ALIGN4_HI(EM_BLE_TX_DESC_END)
#define EM_BLE_LLCPTXBUF_NB        (2*BLE_ACTIVITY_MAX)
#define EM_BLE_LLCPTXBUF_SIZE      35//(LL_PDU_LENGTH_MAX) "co_llcp.h"
...
#define EM_BLE_ADVEXTHDRTXBUF_OFFSET    ALIGN4_HI(EM_BLE_LLCPTXBUF_END)
...
/*
 ...
 #define EM_BLE_ADVDATATXBUF_OFFSET    ALIGN4_HI(EM_BLE_ADVEXTHDRTXBUF_END)
...
#define EM_BLE_AUXCONNECTREQTXBUF_OFFSET    ALIGN4_HI(EM_BLE_ADVDATATXBUF_END)
...
#define EM_BLE_DATARXBUF_OFFSET    ALIGN4_HI(EM_BLE_AUXCONNECTREQTXBUF_END)
...
#define EM_BLE_ACLTXBUF_OFFSET    ALIGN4_HI(EM_BLE_DATARXBUF_END)
 ...
 */
#define EM_BLE_ISO_DESC_OFFSET                ALIGN4_HI(EM_BLE_ACLTXBUF_END)
...
#define EM_BLE_ISO_BUF_OFFSET                 ALIGN4_HI(EM_BLE_ISO_DESC_END)
...
#define EM_BLE_RX_CTE_DESC_OFFSET      ALIGN4_HI(EM_BLE_ISO_BUFFER_END)
...
#define EM_BLE_TX_ANTENNA_ID_OFFSET   ALIGN4_HI(EM_BLE_RX_CTE_DESC_END)
#if (BLE_AOA | BLE_AOD)
...
#define EM_BLE_RX_ANTENNA_ID_OFFSET   ALIGN4_HI(EM_BLE_TX_ANTENNA_ID_END)
#if (BLE_AOA | BLE_AOD)
