...
/// Version
#define VER_CHIPSET          0x020A
#define VER_BURNER           0x020A //2.00
#define VER_BATCH            0x020A //2.00
...
/// Address
#define CHIP_SDRV_ADDR       0x20003600
...
#define FSH_OFST_CRC_BASE    0x18

// Compatible B5x
typedef enum {
	FLASH_PAGE	  = 0, // 256Byte
    FLASH_SECTOR  = 1, // 4kByte
    FLASH_CHIP    = 2, // full chip
} FLASH_EraseDef;
