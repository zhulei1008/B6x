...
//#define TRIM_VAL_NUM            7 // VAL00~VAL05
#define TRIM_VALID_IDX          6 // TRIM_VAL05
#define FSH_TRIM_ADDR        0x18000F00 // not PUYA's flash, first sector(4k Bytes) use to keep trim info
#define FSH_TRIM_OFFSET      (FSH_TRIM_ADDR & 0xFFFFFF)
