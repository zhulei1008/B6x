...
#define EM_BLE_RAL_INFO_ADDR   (EM_BASE_ADDR + EM_BLE_RAL_OFFSET)
#else
#define EM_BLE_RAL_INFO_ADDR   (0x50004000 + EM_BLE_RAL_OFFSET)
#endif

#define EM_BLE_RAL_INFO_INDEX  0x00000000
#define EM_BLE_RAL_INFO_RESET  0x00000000

__INLINE__ uint16_t em_ble_ral_info_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RAL_INFO_ADDR + elt_idx * REG_EM_BLE_RAL_SIZE);
}

__INLINE__ void em_ble_ral_info_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_ral_info_pack(int elt_idx, uint8_t entryvalid, uint8_t connected, uint8_t inwhlist, uint8_t inperadvlist, uint8_t pef, uint8_t localrpavalid, uint8_t localrparenew, uint8_t localirkvalid, uint8_t peerrpavalid, uint8_t peerrparenew, uint8_t peerirkvalid, uint8_t peeridtype)
{
...
__INLINE__ void em_ble_ral_info_unpack(int elt_idx, uint8_t* entryvalid, uint8_t* connected, uint8_t* inwhlist, uint8_t* inperadvlist, uint8_t* pef, uint8_t* localrpavalid, uint8_t* localrparenew, uint8_t* localirkvalid, uint8_t* peerrpavalid, uint8_t* peerrparenew, uint8_t* peerirkvalid, uint8_t* peeridtype)
{
...
__INLINE__ uint8_t em_ble_ral_info_entry_valid_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RAL_INFO_ADDR + elt_idx * REG_EM_BLE_RAL_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__INLINE__ void em_ble_ral_info_entry_valid_setf(int elt_idx, uint8_t entryvalid)
{
    ASSERT_ERR((((uint16_t)entryvalid << 15) & ~((uint16_t)0x00008000)) == 0);
...
__INLINE__ uint8_t em_ble_ral_info_connected_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RAL_INFO_ADDR + elt_idx * REG_EM_BLE_RAL_SIZE);
    return ((localVal & ((uint16_t)0x00004000)) >> 14);
}

__INLINE__ void em_ble_ral_info_connected_setf(int elt_idx, uint8_t connected)
{
    ASSERT_ERR((((uint16_t)connected << 14) & ~((uint16_t)0x00004000)) == 0);
...
__INLINE__ uint8_t em_ble_ral_info_in_whlist_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RAL_INFO_ADDR + elt_idx * REG_EM_BLE_RAL_SIZE);
    return ((localVal & ((uint16_t)0x00002000)) >> 13);
}

__INLINE__ void em_ble_ral_info_in_whlist_setf(int elt_idx, uint8_t inwhlist)
{
    ASSERT_ERR((((uint16_t)inwhlist << 13) & ~((uint16_t)0x00002000)) == 0);
...
__INLINE__ uint8_t em_ble_ral_info_in_peradv_list_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RAL_INFO_ADDR + elt_idx * REG_EM_BLE_RAL_SIZE);
    return ((localVal & ((uint16_t)0x00001000)) >> 12);
}

__INLINE__ void em_ble_ral_info_in_peradv_list_setf(int elt_idx, uint8_t inperadvlist)
{
    ASSERT_ERR((((uint16_t)inperadvlist << 12) & ~((uint16_t)0x00001000)) == 0);
...
__INLINE__ uint8_t em_ble_ral_info_pef_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RAL_INFO_ADDR + elt_idx * REG_EM_BLE_RAL_SIZE);
    return ((localVal & ((uint16_t)0x00000800)) >> 11);
}

__INLINE__ void em_ble_ral_info_pef_setf(int elt_idx, uint8_t pef)
{
    ASSERT_ERR((((uint16_t)pef << 11) & ~((uint16_t)0x00000800)) == 0);
...
__INLINE__ uint8_t em_ble_ral_info_local_rpa_valid_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RAL_INFO_ADDR + elt_idx * REG_EM_BLE_RAL_SIZE);
    return ((localVal & ((uint16_t)0x00000080)) >> 7);
}

__INLINE__ void em_ble_ral_info_local_rpa_valid_setf(int elt_idx, uint8_t localrpavalid)
{
    ASSERT_ERR((((uint16_t)localrpavalid << 7) & ~((uint16_t)0x00000080)) == 0);
...
__INLINE__ uint8_t em_ble_ral_info_local_rpa_renew_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RAL_INFO_ADDR + elt_idx * REG_EM_BLE_RAL_SIZE);
    return ((localVal & ((uint16_t)0x00000040)) >> 6);
}

__INLINE__ void em_ble_ral_info_local_rpa_renew_setf(int elt_idx, uint8_t localrparenew)
{
    ASSERT_ERR((((uint16_t)localrparenew << 6) & ~((uint16_t)0x00000040)) == 0);
...
__INLINE__ uint8_t em_ble_ral_info_local_irk_valid_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RAL_INFO_ADDR + elt_idx * REG_EM_BLE_RAL_SIZE);
    return ((localVal & ((uint16_t)0x00000020)) >> 5);
}

__INLINE__ void em_ble_ral_info_local_irk_valid_setf(int elt_idx, uint8_t localirkvalid)
{
    ASSERT_ERR((((uint16_t)localirkvalid << 5) & ~((uint16_t)0x00000020)) == 0);
...
__INLINE__ uint8_t em_ble_ral_info_peer_rpa_valid_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RAL_INFO_ADDR + elt_idx * REG_EM_BLE_RAL_SIZE);
    return ((localVal & ((uint16_t)0x00000008)) >> 3);
}

__INLINE__ void em_ble_ral_info_peer_rpa_valid_setf(int elt_idx, uint8_t peerrpavalid)
{
    ASSERT_ERR((((uint16_t)peerrpavalid << 3) & ~((uint16_t)0x00000008)) == 0);
...
__INLINE__ uint8_t em_ble_ral_info_peer_rpa_renew_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RAL_INFO_ADDR + elt_idx * REG_EM_BLE_RAL_SIZE);
    return ((localVal & ((uint16_t)0x00000004)) >> 2);
}

__INLINE__ void em_ble_ral_info_peer_rpa_renew_setf(int elt_idx, uint8_t peerrparenew)
{
    ASSERT_ERR((((uint16_t)peerrparenew << 2) & ~((uint16_t)0x00000004)) == 0);
...
__INLINE__ uint8_t em_ble_ral_info_peer_irk_valid_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RAL_INFO_ADDR + elt_idx * REG_EM_BLE_RAL_SIZE);
    return ((localVal & ((uint16_t)0x00000002)) >> 1);
}

__INLINE__ void em_ble_ral_info_peer_irk_valid_setf(int elt_idx, uint8_t peerirkvalid)
{
    ASSERT_ERR((((uint16_t)peerirkvalid << 1) & ~((uint16_t)0x00000002)) == 0);
...
__INLINE__ uint8_t em_ble_ral_info_peer_id_type_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RAL_INFO_ADDR + elt_idx * REG_EM_BLE_RAL_SIZE);
    return ((localVal & ((uint16_t)0x00000001)) >> 0);
}

__INLINE__ void em_ble_ral_info_peer_id_type_setf(int elt_idx, uint8_t peeridtype)
{
    ASSERT_ERR((((uint16_t)peeridtype << 0) & ~((uint16_t)0x00000001)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RAL_PEER_SID_ADDR   (EM_BASE_ADDR + 0x02 + EM_BLE_RAL_OFFSET)
#else
#define EM_BLE_RAL_PEER_SID_ADDR   (0x50004002 + EM_BLE_RAL_OFFSET)
#endif

#define EM_BLE_RAL_PEER_SID_INDEX  0x00000001
#define EM_BLE_RAL_PEER_SID_RESET  0x00000000

__INLINE__ uint16_t em_ble_ral_peer_sid_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RAL_PEER_SID_ADDR + elt_idx * REG_EM_BLE_RAL_SIZE);
}

__INLINE__ void em_ble_ral_peer_sid_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_ral_peer_sid_getf(int elt_idx)
{
...
__INLINE__ void em_ble_ral_peer_sid_setf(int elt_idx, uint16_t ralpeersid)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RAL_PEER_IRK_ADDR   (EM_BASE_ADDR + 0x04 + EM_BLE_RAL_OFFSET)
#else
#define EM_BLE_RAL_PEER_IRK_ADDR   (0x50004004 + EM_BLE_RAL_OFFSET)
#endif
...
__INLINE__ uint16_t em_ble_ral_peer_irk_get(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 7);
    return EM_BLE_RD(EM_BLE_RAL_PEER_IRK_ADDR + elt_idx * REG_EM_BLE_RAL_SIZE + reg_idx * 2);
}

__INLINE__ void em_ble_ral_peer_irk_set(int elt_idx, int reg_idx, uint16_t value)
{
    ASSERT_ERR(reg_idx <= 7);
...
__INLINE__ uint16_t em_ble_ral_peer_irk_peer_irk_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 7);
...
__INLINE__ void em_ble_ral_peer_irk_peer_irk_setf(int elt_idx, int reg_idx, uint16_t peerirk)
{
    ASSERT_ERR(reg_idx <= 7);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RAL_PEER_RPA_ADDR   (EM_BASE_ADDR + 0x14 + EM_BLE_RAL_OFFSET)
#else
#define EM_BLE_RAL_PEER_RPA_ADDR   (0x50004014 + EM_BLE_RAL_OFFSET)
#endif
...
__INLINE__ uint16_t em_ble_ral_peer_rpa_get(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 2);
    return EM_BLE_RD(EM_BLE_RAL_PEER_RPA_ADDR + elt_idx * REG_EM_BLE_RAL_SIZE + reg_idx * 2);
}

__INLINE__ void em_ble_ral_peer_rpa_set(int elt_idx, int reg_idx, uint16_t value)
{
    ASSERT_ERR(reg_idx <= 2);
...
__INLINE__ uint16_t em_ble_ral_peer_rpa_peer_rpa_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 2);
...
__INLINE__ void em_ble_ral_peer_rpa_peer_rpa_setf(int elt_idx, int reg_idx, uint16_t peerrpa)
{
    ASSERT_ERR(reg_idx <= 2);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RAL_PEER_ID_ADDR   (EM_BASE_ADDR + 0x1A + EM_BLE_RAL_OFFSET)
#else
#define EM_BLE_RAL_PEER_ID_ADDR   (0x5000401A + EM_BLE_RAL_OFFSET)
#endif
...
__INLINE__ uint16_t em_ble_ral_peer_id_get(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 2);
    return EM_BLE_RD(EM_BLE_RAL_PEER_ID_ADDR + elt_idx * REG_EM_BLE_RAL_SIZE + reg_idx * 2);
}

__INLINE__ void em_ble_ral_peer_id_set(int elt_idx, int reg_idx, uint16_t value)
{
    ASSERT_ERR(reg_idx <= 2);
...
__INLINE__ uint16_t em_ble_ral_peer_id_peer_id_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 2);
...
__INLINE__ void em_ble_ral_peer_id_peer_id_setf(int elt_idx, int reg_idx, uint16_t peerid)
{
    ASSERT_ERR(reg_idx <= 2);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RAL_LOCAL_IRK_ADDR   (EM_BASE_ADDR + 0x20 + EM_BLE_RAL_OFFSET)
#else
#define EM_BLE_RAL_LOCAL_IRK_ADDR   (0x50004020 + EM_BLE_RAL_OFFSET)
#endif
...
__INLINE__ uint16_t em_ble_ral_local_irk_get(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 7);
    return EM_BLE_RD(EM_BLE_RAL_LOCAL_IRK_ADDR + elt_idx * REG_EM_BLE_RAL_SIZE + reg_idx * 2);
}

__INLINE__ void em_ble_ral_local_irk_set(int elt_idx, int reg_idx, uint16_t value)
{
    ASSERT_ERR(reg_idx <= 7);
...
__INLINE__ uint16_t em_ble_ral_local_irk_local_irk_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 7);
...
__INLINE__ void em_ble_ral_local_irk_local_irk_setf(int elt_idx, int reg_idx, uint16_t localirk)
{
    ASSERT_ERR(reg_idx <= 7);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RAL_LOCAL_RPA_ADDR   (EM_BASE_ADDR + 0x30 + EM_BLE_RAL_OFFSET)
#else
#define EM_BLE_RAL_LOCAL_RPA_ADDR   (0x50004030 + EM_BLE_RAL_OFFSET)
#endif
...
__INLINE__ uint16_t em_ble_ral_local_rpa_get(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 2);
    return EM_BLE_RD(EM_BLE_RAL_LOCAL_RPA_ADDR + elt_idx * REG_EM_BLE_RAL_SIZE + reg_idx * 2);
}

__INLINE__ void em_ble_ral_local_rpa_set(int elt_idx, int reg_idx, uint16_t value)
{
    ASSERT_ERR(reg_idx <= 2);
...
__INLINE__ uint16_t em_ble_ral_local_rpa_local_rpa_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 2);
...
__INLINE__ void em_ble_ral_local_rpa_local_rpa_setf(int elt_idx, int reg_idx, uint16_t localrpa)
{
    ASSERT_ERR(reg_idx <= 2);
