...
#define EM_BT_EXTAB_ADDR   (EM_BASE_ADDR + EM_ET_OFFSET)
#else
#define EM_BT_EXTAB_ADDR   (0x50004000 + EM_ET_OFFSET)
#endif

#define EM_BT_EXTAB_INDEX  0x00000000
#define EM_BT_EXTAB_RESET  0x00000000

__INLINE__ uint16_t em_bt_extab_get(int elt_idx)
{
    return EM_RD(EM_BT_EXTAB_ADDR + elt_idx * REG_EM_ET_SIZE);
}

__INLINE__ void em_bt_extab_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_bt_extab_pack(int elt_idx, uint8_t schprio1, uint8_t spa, uint8_t csb, uint8_t sniff, uint8_t rsvd, uint8_t esco, uint8_t status, uint8_t mode)
{
...
__INLINE__ void em_bt_extab_unpack(int elt_idx, uint8_t* schprio1, uint8_t* spa, uint8_t* csb, uint8_t* sniff, uint8_t* rsvd, uint8_t* esco, uint8_t* status, uint8_t* mode)
{
...
__INLINE__ uint8_t em_bt_extab_sch_prio1_getf(int elt_idx)
{
    uint16_t localVal = EM_RD(EM_BT_EXTAB_ADDR + elt_idx * REG_EM_ET_SIZE);
    return ((localVal & ((uint16_t)0x0000F800)) >> 11);
}

__INLINE__ void em_bt_extab_sch_prio1_setf(int elt_idx, uint8_t schprio1)
{
    ASSERT_ERR((((uint16_t)schprio1 << 11) & ~((uint16_t)0x0000F800)) == 0);
...
__INLINE__ uint8_t em_bt_extab_spa_getf(int elt_idx)
{
    uint16_t localVal = EM_RD(EM_BT_EXTAB_ADDR + elt_idx * REG_EM_ET_SIZE);
    return ((localVal & ((uint16_t)0x00000400)) >> 10);
}

__INLINE__ void em_bt_extab_spa_setf(int elt_idx, uint8_t spa)
{
    ASSERT_ERR((((uint16_t)spa << 10) & ~((uint16_t)0x00000400)) == 0);
...
__INLINE__ uint8_t em_bt_extab_csb_getf(int elt_idx)
{
    uint16_t localVal = EM_RD(EM_BT_EXTAB_ADDR + elt_idx * REG_EM_ET_SIZE);
    return ((localVal & ((uint16_t)0x00000200)) >> 9);
}

__INLINE__ void em_bt_extab_csb_setf(int elt_idx, uint8_t csb)
{
    ASSERT_ERR((((uint16_t)csb << 9) & ~((uint16_t)0x00000200)) == 0);
...
__INLINE__ uint8_t em_bt_extab_sniff_getf(int elt_idx)
{
    uint16_t localVal = EM_RD(EM_BT_EXTAB_ADDR + elt_idx * REG_EM_ET_SIZE);
    return ((localVal & ((uint16_t)0x00000100)) >> 8);
}

__INLINE__ void em_bt_extab_sniff_setf(int elt_idx, uint8_t sniff)
{
    ASSERT_ERR((((uint16_t)sniff << 8) & ~((uint16_t)0x00000100)) == 0);
...
__INLINE__ uint8_t em_bt_extab_rsvd_getf(int elt_idx)
{
    uint16_t localVal = EM_RD(EM_BT_EXTAB_ADDR + elt_idx * REG_EM_ET_SIZE);
    return ((localVal & ((uint16_t)0x00000080)) >> 7);
}

__INLINE__ void em_bt_extab_rsvd_setf(int elt_idx, uint8_t rsvd)
{
    ASSERT_ERR((((uint16_t)rsvd << 7) & ~((uint16_t)0x00000080)) == 0);
...
__INLINE__ uint8_t em_bt_extab_e_sco_getf(int elt_idx)
{
    uint16_t localVal = EM_RD(EM_BT_EXTAB_ADDR + elt_idx * REG_EM_ET_SIZE);
    return ((localVal & ((uint16_t)0x00000040)) >> 6);
}

__INLINE__ void em_bt_extab_e_sco_setf(int elt_idx, uint8_t esco)
{
    ASSERT_ERR((((uint16_t)esco << 6) & ~((uint16_t)0x00000040)) == 0);
...
__INLINE__ uint8_t em_bt_extab_status_getf(int elt_idx)
{
    uint16_t localVal = EM_RD(EM_BT_EXTAB_ADDR + elt_idx * REG_EM_ET_SIZE);
    return ((localVal & ((uint16_t)0x00000038)) >> 3);
}

__INLINE__ void em_bt_extab_status_setf(int elt_idx, uint8_t status)
{
    ASSERT_ERR((((uint16_t)status << 3) & ~((uint16_t)0x00000038)) == 0);
...
__INLINE__ uint8_t em_bt_extab_mode_getf(int elt_idx)
{
    uint16_t localVal = EM_RD(EM_BT_EXTAB_ADDR + elt_idx * REG_EM_ET_SIZE);
    return ((localVal & ((uint16_t)0x00000007)) >> 0);
}

__INLINE__ void em_bt_extab_mode_setf(int elt_idx, uint8_t mode)
{
    ASSERT_ERR((((uint16_t)mode << 0) & ~((uint16_t)0x00000007)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_LE_EXTAB_ADDR   (EM_BASE_ADDR + EM_ET_OFFSET)
#else
#define EM_LE_EXTAB_ADDR   (0x50004000 + EM_ET_OFFSET)
#endif

#define EM_LE_EXTAB_INDEX  0x00000000
#define EM_LE_EXTAB_RESET  0x00000000

__INLINE__ uint16_t em_le_extab_get(int elt_idx)
{
    return EM_RD(EM_LE_EXTAB_ADDR + elt_idx * REG_EM_ET_SIZE);
}

__INLINE__ void em_le_extab_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_le_extab_pack(int elt_idx, uint8_t schprio1, uint8_t spa, uint8_t aenps, 
    uint8_t rsvd, uint8_t iso, uint8_t status, uint8_t mode)
{
    ASSERT_ERR((((uint16_t)schprio1 << 11) & ~((uint16_t)0x0000F800)) == 0);
    ASSERT_ERR((((uint16_t)spa << 10) & ~((uint16_t)0x00000400)) == 0);
...
__INLINE__ void em_le_extab_unpack(int elt_idx, uint8_t* schprio1, uint8_t* spa, uint8_t* aenps, uint8_t* rsvd, uint8_t* iso, uint8_t* status, uint8_t* mode)
{
...
__INLINE__ uint8_t em_le_extab_sch_prio1_getf(int elt_idx)
{
    uint16_t localVal = EM_RD(EM_LE_EXTAB_ADDR + elt_idx * REG_EM_ET_SIZE);
    return ((localVal & ((uint16_t)0x0000F800)) >> 11);
}

__INLINE__ void em_le_extab_sch_prio1_setf(int elt_idx, uint8_t schprio1)
{
    ASSERT_ERR((((uint16_t)schprio1 << 11) & ~((uint16_t)0x0000F800)) == 0);
...
__INLINE__ uint8_t em_le_extab_spa_getf(int elt_idx)
{
    uint16_t localVal = EM_RD(EM_LE_EXTAB_ADDR + elt_idx * REG_EM_ET_SIZE);
    return ((localVal & ((uint16_t)0x00000400)) >> 10);
}

__INLINE__ void em_le_extab_spa_setf(int elt_idx, uint8_t spa)
{
    ASSERT_ERR((((uint16_t)spa << 10) & ~((uint16_t)0x00000400)) == 0);
...
__INLINE__ uint8_t em_le_extab_ae_nps_getf(int elt_idx)
{
    uint16_t localVal = EM_RD(EM_LE_EXTAB_ADDR + elt_idx * REG_EM_ET_SIZE);
    return ((localVal & ((uint16_t)0x00000100)) >> 8);
}

__INLINE__ void em_le_extab_ae_nps_setf(int elt_idx, uint8_t aenps)
{
    ASSERT_ERR((((uint16_t)aenps << 8) & ~((uint16_t)0x00000100)) == 0);
...
__INLINE__ uint8_t em_le_extab_rsvd_getf(int elt_idx)
{
    uint16_t localVal = EM_RD(EM_LE_EXTAB_ADDR + elt_idx * REG_EM_ET_SIZE);
    return ((localVal & ((uint16_t)0x00000080)) >> 7);
}

__INLINE__ void em_le_extab_rsvd_setf(int elt_idx, uint8_t rsvd)
{
    ASSERT_ERR((((uint16_t)rsvd << 7) & ~((uint16_t)0x00000080)) == 0);
...
__INLINE__ uint8_t em_le_extab_iso_getf(int elt_idx)
{
    uint16_t localVal = EM_RD(EM_LE_EXTAB_ADDR + elt_idx * REG_EM_ET_SIZE);
    return ((localVal & ((uint16_t)0x00000040)) >> 6);
}

__INLINE__ void em_le_extab_iso_setf(int elt_idx, uint8_t iso)
{
    ASSERT_ERR((((uint16_t)iso << 6) & ~((uint16_t)0x00000040)) == 0);
...
__INLINE__ uint8_t em_le_extab_status_getf(int elt_idx)
{
    uint16_t localVal = EM_RD(EM_LE_EXTAB_ADDR + elt_idx * REG_EM_ET_SIZE);
    return ((localVal & ((uint16_t)0x00000038)) >> 3);
}

__INLINE__ void em_le_extab_status_setf(int elt_idx, uint8_t status)
{
    ASSERT_ERR((((uint16_t)status << 3) & ~((uint16_t)0x00000038)) == 0);
...
__INLINE__ uint8_t em_le_extab_mode_getf(int elt_idx)
{
    uint16_t localVal = EM_RD(EM_LE_EXTAB_ADDR + elt_idx * REG_EM_ET_SIZE);
    return ((localVal & ((uint16_t)0x00000007)) >> 0);
}

__INLINE__ void em_le_extab_mode_setf(int elt_idx, uint8_t mode)
{
    ASSERT_ERR((((uint16_t)mode << 0) & ~((uint16_t)0x00000007)) == 0);
...
#else
#define EM_RAWSTP0_ADDR   (0x50004002 + EM_ET_OFFSET)
#endif

#define EM_RAWSTP0_INDEX  0x00000001
#define EM_RAWSTP0_RESET  0x00000000

__INLINE__ uint16_t em_rawstp0_get(int elt_idx)
{
    return EM_RD(EM_RAWSTP0_ADDR + elt_idx * REG_EM_ET_SIZE);
}

__INLINE__ void em_rawstp0_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_rawstp0_getf(int elt_idx)
{
...
__INLINE__ void em_rawstp0_setf(int elt_idx, uint16_t rawstp0)
{
...
#else
#define EM_RAWSTP1_ADDR   (0x50004004 + EM_ET_OFFSET)
#endif

#define EM_RAWSTP1_INDEX  0x00000002
#define EM_RAWSTP1_RESET  0x00000000

__INLINE__ uint16_t em_rawstp1_get(int elt_idx)
{
    return EM_RD(EM_RAWSTP1_ADDR + elt_idx * REG_EM_ET_SIZE);
}

__INLINE__ void em_rawstp1_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_rawstp1_getf(int elt_idx)
{
...
__INLINE__ void em_rawstp1_setf(int elt_idx, uint16_t rawstp1)
{
...
#else
#define EM_FINESTP_ADDR   (0x50004006 + EM_ET_OFFSET)
#endif

#define EM_FINESTP_INDEX  0x00000003
#define EM_FINESTP_RESET  0x00000000

__INLINE__ uint16_t em_finestp_get(int elt_idx)
{
    return EM_RD(EM_FINESTP_ADDR + elt_idx * REG_EM_ET_SIZE);
}

__INLINE__ void em_finestp_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_finestp_getf(int elt_idx)
{
...
__INLINE__ void em_finestp_setf(int elt_idx, uint16_t finestp)
{
...
#else
#define EM_CSPTR_ADDR   (0x50004008 + EM_ET_OFFSET)
#endif

#define EM_CSPTR_INDEX  0x00000004
#define EM_CSPTR_RESET  0x00000000

__INLINE__ uint16_t em_csptr_get(int elt_idx)
{
    return EM_RD(EM_CSPTR_ADDR + elt_idx * REG_EM_ET_SIZE);
}

__INLINE__ void em_csptr_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_csptr_getf(int elt_idx)
{
...
__INLINE__ void em_csptr_setf(int elt_idx, uint16_t csptr)
{
...
#else
#define EM_PRIOBW_ADDR   (0x5000400A + EM_ET_OFFSET)
#endif

#define EM_PRIOBW_INDEX  0x00000005
#define EM_PRIOBW_RESET  0x00000000

__INLINE__ uint16_t em_priobw_get(int elt_idx)
{
    return EM_RD(EM_PRIOBW_ADDR + elt_idx * REG_EM_ET_SIZE);
}

__INLINE__ void em_priobw_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_priobw_pack(int elt_idx, uint8_t priobwunit, uint16_t priobw)
{
...
__INLINE__ void em_priobw_unpack(int elt_idx, uint8_t* priobwunit, uint16_t* priobw)
{
...
__INLINE__ uint8_t em_priobw_priobw_unit_getf(int elt_idx)
{
    uint16_t localVal = EM_RD(EM_PRIOBW_ADDR + elt_idx * REG_EM_ET_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__INLINE__ void em_priobw_priobw_unit_setf(int elt_idx, uint8_t priobwunit)
{
    ASSERT_ERR((((uint16_t)priobwunit << 15) & ~((uint16_t)0x00008000)) == 0);
...
__INLINE__ uint16_t em_priobw_priobw_getf(int elt_idx)
{
    uint16_t localVal = EM_RD(EM_PRIOBW_ADDR + elt_idx * REG_EM_ET_SIZE);
    return ((localVal & ((uint16_t)0x00007FFF)) >> 0);
}

__INLINE__ void em_priobw_priobw_setf(int elt_idx, uint16_t priobw)
{
    ASSERT_ERR((((uint16_t)priobw << 0) & ~((uint16_t)0x00007FFF)) == 0);
...
#else
#define EM_PRIOLVL_ADDR   (0x5000400C + EM_ET_OFFSET)
#endif

#define EM_PRIOLVL_INDEX  0x00000006
#define EM_PRIOLVL_RESET  0x00000000

__INLINE__ uint16_t em_priolvl_get(int elt_idx)
{
    return EM_RD(EM_PRIOLVL_ADDR + elt_idx * REG_EM_ET_SIZE);
}

__INLINE__ void em_priolvl_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_priolvl_pack(int elt_idx, uint8_t schprio3, uint8_t schprio2)
{
...
__INLINE__ void em_priolvl_unpack(int elt_idx, uint8_t* schprio3, uint8_t* schprio2)
{
...
__INLINE__ uint8_t em_priolvl_sch_prio3_getf(int elt_idx)
{
    uint16_t localVal = EM_RD(EM_PRIOLVL_ADDR + elt_idx * REG_EM_ET_SIZE);
    return ((localVal & ((uint16_t)0x00001F00)) >> 8);
}

__INLINE__ void em_priolvl_sch_prio3_setf(int elt_idx, uint8_t schprio3)
{
    ASSERT_ERR((((uint16_t)schprio3 << 8) & ~((uint16_t)0x00001F00)) == 0);
...
__INLINE__ uint8_t em_priolvl_sch_prio2_getf(int elt_idx)
{
    uint16_t localVal = EM_RD(EM_PRIOLVL_ADDR + elt_idx * REG_EM_ET_SIZE);
    return ((localVal & ((uint16_t)0x0000001F)) >> 0);
}

__INLINE__ void em_priolvl_sch_prio2_setf(int elt_idx, uint8_t schprio2)
{
    ASSERT_ERR((((uint16_t)schprio2 << 0) & ~((uint16_t)0x0000001F)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_PTI_VXCHAN_ADDR   (EM_BASE_ADDR + 0x0E + EM_ET_OFFSET)
#else
#define EM_PTI_VXCHAN_ADDR   (0x5000400E + EM_ET_OFFSET)
#endif

#define EM_PTI_VXCHAN_INDEX  0x00000007
#define EM_PTI_VXCHAN_RESET  0x00000000

__INLINE__ uint16_t em_pti_vxchan_get(int elt_idx)
{
    return EM_RD(EM_PTI_VXCHAN_ADDR + elt_idx * REG_EM_ET_SIZE);
}

__INLINE__ void em_pti_vxchan_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_pti_vxchan_pack(int elt_idx, uint8_t ptiprio, uint8_t vxchan)
{
...
__INLINE__ void em_pti_vxchan_unpack(int elt_idx, uint8_t* ptiprio, uint8_t* vxchan)
{
...
__INLINE__ uint8_t em_pti_vxchan_pti_prio_getf(int elt_idx)
{
    uint16_t localVal = EM_RD(EM_PTI_VXCHAN_ADDR + elt_idx * REG_EM_ET_SIZE);
    return ((localVal & ((uint16_t)0x00001F00)) >> 8);
}

__INLINE__ void em_pti_vxchan_pti_prio_setf(int elt_idx, uint8_t ptiprio)
{
    ASSERT_ERR((((uint16_t)ptiprio << 8) & ~((uint16_t)0x00001F00)) == 0);
...
__INLINE__ uint8_t em_pti_vxchan_vxchan_getf(int elt_idx)
{
    uint16_t localVal = EM_RD(EM_PTI_VXCHAN_ADDR + elt_idx * REG_EM_ET_SIZE);
    return ((localVal & ((uint16_t)0x00000003)) >> 0);
}

__INLINE__ void em_pti_vxchan_vxchan_setf(int elt_idx, uint8_t vxchan)
{
    ASSERT_ERR((((uint16_t)vxchan << 0) & ~((uint16_t)0x00000003)) == 0);
