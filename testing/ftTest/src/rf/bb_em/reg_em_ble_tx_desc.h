...
#define EM_BLE_TXCNTL_ADDR   (EM_BASE_ADDR + EM_BLE_TX_DESC_OFFSET)
#else
#define EM_BLE_TXCNTL_ADDR   (0x50004000 + EM_BLE_TX_DESC_OFFSET)
#endif

#define EM_BLE_TXCNTL_INDEX  0x00000000
#define EM_BLE_TXCNTL_RESET  0x00000000

__INLINE__ uint16_t em_ble_txcntl_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXCNTL_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
}

__INLINE__ void em_ble_txcntl_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_txcntl_pack(int elt_idx, uint8_t txdone, uint16_t nextptr)
{
...
__INLINE__ void em_ble_txcntl_unpack(int elt_idx, uint8_t* txdone, uint16_t* nextptr)
{
...
__INLINE__ uint8_t em_ble_txcntl_txdone_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXCNTL_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__INLINE__ void em_ble_txcntl_txdone_setf(int elt_idx, uint8_t txdone)
{
    ASSERT_ERR((((uint16_t)txdone << 15) & ~((uint16_t)0x00008000)) == 0);
...
__INLINE__ uint16_t em_ble_txcntl_next_ptr_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXCNTL_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00003FFF)) >> 0);
}

__INLINE__ void em_ble_txcntl_next_ptr_setf(int elt_idx, uint16_t nextptr)
{
    ASSERT_ERR((((uint16_t)nextptr << 0) & ~((uint16_t)0x00003FFF)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_TXPHCE_ADDR   (EM_BASE_ADDR +0x02 + EM_BLE_TX_DESC_OFFSET)
#else
#define EM_BLE_TXPHCE_ADDR   (0x50004002 + EM_BLE_TX_DESC_OFFSET)
#endif

#define EM_BLE_TXPHCE_INDEX  0x00000001
#define EM_BLE_TXPHCE_RESET  0x00000000

__INLINE__ uint16_t em_ble_txphce_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXPHCE_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
}

__INLINE__ void em_ble_txphce_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_txphce_pack(int elt_idx, uint8_t txlen, uint8_t txaclrfu, uint8_t txcp, uint8_t txmd, uint8_t txsn, uint8_t txnesn, uint8_t txllid)
{
...
__INLINE__ void em_ble_txphce_unpack(int elt_idx, uint8_t* txlen, uint8_t* txaclrfu, uint8_t* txcp, uint8_t* txmd, uint8_t* txsn, uint8_t* txnesn, uint8_t* txllid)
{
...
__INLINE__ uint8_t em_ble_txphce_txlen_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXPHCE_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000FF00)) >> 8);
}

__INLINE__ void em_ble_txphce_txlen_setf(int elt_idx, uint8_t txlen)
{
    ASSERT_ERR((((uint16_t)txlen << 8) & ~((uint16_t)0x0000FF00)) == 0);
...
__INLINE__ uint8_t em_ble_txphce_txaclrfu_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXPHCE_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x000000C0)) >> 6);
}

__INLINE__ void em_ble_txphce_txaclrfu_setf(int elt_idx, uint8_t txaclrfu)
{
    ASSERT_ERR((((uint16_t)txaclrfu << 6) & ~((uint16_t)0x000000C0)) == 0);
...
__INLINE__ uint8_t em_ble_txphce_txcp_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXPHCE_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000020)) >> 5);
}

__INLINE__ void em_ble_txphce_txcp_setf(int elt_idx, uint8_t txcp)
{
    ASSERT_ERR((((uint16_t)txcp << 5) & ~((uint16_t)0x00000020)) == 0);
...
__INLINE__ uint8_t em_ble_txphce_txmd_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXPHCE_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000010)) >> 4);
}

__INLINE__ void em_ble_txphce_txmd_setf(int elt_idx, uint8_t txmd)
{
    ASSERT_ERR((((uint16_t)txmd << 4) & ~((uint16_t)0x00000010)) == 0);
...
__INLINE__ uint8_t em_ble_txphce_txsn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXPHCE_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000008)) >> 3);
}

__INLINE__ void em_ble_txphce_txsn_setf(int elt_idx, uint8_t txsn)
{
    ASSERT_ERR((((uint16_t)txsn << 3) & ~((uint16_t)0x00000008)) == 0);
...
__INLINE__ uint8_t em_ble_txphce_txnesn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXPHCE_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000004)) >> 2);
}

__INLINE__ void em_ble_txphce_txnesn_setf(int elt_idx, uint8_t txnesn)
{
    ASSERT_ERR((((uint16_t)txnesn << 2) & ~((uint16_t)0x00000004)) == 0);
...
__INLINE__ uint8_t em_ble_txphce_txllid_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXPHCE_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000003)) >> 0);
}

__INLINE__ void em_ble_txphce_txllid_setf(int elt_idx, uint8_t txllid)
{
    ASSERT_ERR((((uint16_t)txllid << 0) & ~((uint16_t)0x00000003)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_TXPHADV_ADDR   (EM_BASE_ADDR +0x02 + EM_BLE_TX_DESC_OFFSET)
#else
#define EM_BLE_TXPHADV_ADDR   (0x50004002 + EM_BLE_TX_DESC_OFFSET)
#endif

#define EM_BLE_TXPHADV_INDEX  0x00000001
#define EM_BLE_TXPHADV_RESET  0x00000000

__INLINE__ uint16_t em_ble_txphadv_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXPHADV_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
}

__INLINE__ void em_ble_txphadv_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_txphadv_pack(int elt_idx, uint8_t txadvlen, uint8_t txrxadd, uint8_t txtxadd, uint8_t txchsel2, uint8_t txadvrfu, uint8_t txtype)
{
...
__INLINE__ void em_ble_txphadv_unpack(int elt_idx, uint8_t* txadvlen, uint8_t* txrxadd, uint8_t* txtxadd, uint8_t* txchsel2, uint8_t* txadvrfu, uint8_t* txtype)
{
...
__INLINE__ uint8_t em_ble_txphadv_txadvlen_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXPHADV_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000FF00)) >> 8);
}

__INLINE__ void em_ble_txphadv_txadvlen_setf(int elt_idx, uint8_t txadvlen)
{
    ASSERT_ERR((((uint16_t)txadvlen << 8) & ~((uint16_t)0x0000FF00)) == 0);
...
__INLINE__ uint8_t em_ble_txphadv_txrxadd_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXPHADV_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000080)) >> 7);
}

__INLINE__ void em_ble_txphadv_txrxadd_setf(int elt_idx, uint8_t txrxadd)
{
    ASSERT_ERR((((uint16_t)txrxadd << 7) & ~((uint16_t)0x00000080)) == 0);
...
__INLINE__ uint8_t em_ble_txphadv_txtxadd_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXPHADV_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000040)) >> 6);
}

__INLINE__ void em_ble_txphadv_txtxadd_setf(int elt_idx, uint8_t txtxadd)
{
    ASSERT_ERR((((uint16_t)txtxadd << 6) & ~((uint16_t)0x00000040)) == 0);
...
__INLINE__ uint8_t em_ble_txphadv_txchsel2_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXPHADV_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000020)) >> 5);
}

__INLINE__ void em_ble_txphadv_txchsel2_setf(int elt_idx, uint8_t txchsel2)
{
    ASSERT_ERR((((uint16_t)txchsel2 << 5) & ~((uint16_t)0x00000020)) == 0);
...
__INLINE__ uint8_t em_ble_txphadv_txadvrfu_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXPHADV_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000010)) >> 4);
}

__INLINE__ void em_ble_txphadv_txadvrfu_setf(int elt_idx, uint8_t txadvrfu)
{
    ASSERT_ERR((((uint16_t)txadvrfu << 4) & ~((uint16_t)0x00000010)) == 0);
...
__INLINE__ uint8_t em_ble_txphadv_txtype_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXPHADV_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000000F)) >> 0);
}

__INLINE__ void em_ble_txphadv_txtype_setf(int elt_idx, uint8_t txtype)
{
    ASSERT_ERR((((uint16_t)txtype << 0) & ~((uint16_t)0x0000000F)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_TXDATAPTR_ADDR   (EM_BASE_ADDR +0x04 + EM_BLE_TX_DESC_OFFSET)
#else
#define EM_BLE_TXDATAPTR_ADDR   (0x50004004 + EM_BLE_TX_DESC_OFFSET)
#endif

#define EM_BLE_TXDATAPTR_INDEX  0x00000002
#define EM_BLE_TXDATAPTR_RESET  0x00000000

__INLINE__ uint16_t em_ble_txdataptr_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXDATAPTR_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
}

__INLINE__ void em_ble_txdataptr_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_txdataptr_getf(int elt_idx)
{
...
__INLINE__ void em_ble_txdataptr_setf(int elt_idx, uint16_t txdataptr)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_TXAEHEADER_ADDR   (EM_BASE_ADDR +0x06 + EM_BLE_TX_DESC_OFFSET)
#else
#define EM_BLE_TXAEHEADER_ADDR   (0x50004006 + EM_BLE_TX_DESC_OFFSET)
#endif

#define EM_BLE_TXAEHEADER_INDEX  0x00000003
#define EM_BLE_TXAEHEADER_RESET  0x00000000

__INLINE__ uint16_t em_ble_txaeheader_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXAEHEADER_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
}

__INLINE__ void em_ble_txaeheader_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_txaeheader_pack(int elt_idx, uint8_t txrsvd, uint8_t txpow, uint8_t txsync, uint8_t txauxptr, uint8_t txadi, uint8_t txsupp, uint8_t txtgta, uint8_t txadva, uint8_t txaemode, uint8_t txaelength)
{
...
__INLINE__ void em_ble_txaeheader_unpack(int elt_idx, uint8_t* txrsvd, uint8_t* txpow, uint8_t* txsync, uint8_t* txauxptr, uint8_t* txadi, uint8_t* txsupp, uint8_t* txtgta, uint8_t* txadva, uint8_t* txaemode, uint8_t* txaelength)
{
...
__INLINE__ uint8_t em_ble_txaeheader_txrsvd_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXAEHEADER_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__INLINE__ void em_ble_txaeheader_txrsvd_setf(int elt_idx, uint8_t txrsvd)
{
    ASSERT_ERR((((uint16_t)txrsvd << 15) & ~((uint16_t)0x00008000)) == 0);
...
__INLINE__ uint8_t em_ble_txaeheader_txpow_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXAEHEADER_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00004000)) >> 14);
}

__INLINE__ void em_ble_txaeheader_txpow_setf(int elt_idx, uint8_t txpow)
{
    ASSERT_ERR((((uint16_t)txpow << 14) & ~((uint16_t)0x00004000)) == 0);
...
__INLINE__ uint8_t em_ble_txaeheader_txsync_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXAEHEADER_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00002000)) >> 13);
}

__INLINE__ void em_ble_txaeheader_txsync_setf(int elt_idx, uint8_t txsync)
{
    ASSERT_ERR((((uint16_t)txsync << 13) & ~((uint16_t)0x00002000)) == 0);
...
__INLINE__ uint8_t em_ble_txaeheader_txauxptr_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXAEHEADER_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00001000)) >> 12);
}

__INLINE__ void em_ble_txaeheader_txauxptr_setf(int elt_idx, uint8_t txauxptr)
{
    ASSERT_ERR((((uint16_t)txauxptr << 12) & ~((uint16_t)0x00001000)) == 0);
...
__INLINE__ uint8_t em_ble_txaeheader_txadi_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXAEHEADER_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000800)) >> 11);
}

__INLINE__ void em_ble_txaeheader_txadi_setf(int elt_idx, uint8_t txadi)
{
    ASSERT_ERR((((uint16_t)txadi << 11) & ~((uint16_t)0x00000800)) == 0);
...
__INLINE__ uint8_t em_ble_txaeheader_txsupp_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXAEHEADER_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000400)) >> 10);
}

__INLINE__ void em_ble_txaeheader_txsupp_setf(int elt_idx, uint8_t txsupp)
{
    ASSERT_ERR((((uint16_t)txsupp << 10) & ~((uint16_t)0x00000400)) == 0);
...
__INLINE__ uint8_t em_ble_txaeheader_txtgta_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXAEHEADER_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000200)) >> 9);
}

__INLINE__ void em_ble_txaeheader_txtgta_setf(int elt_idx, uint8_t txtgta)
{
    ASSERT_ERR((((uint16_t)txtgta << 9) & ~((uint16_t)0x00000200)) == 0);
...
__INLINE__ uint8_t em_ble_txaeheader_txadva_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXAEHEADER_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000100)) >> 8);
}

__INLINE__ void em_ble_txaeheader_txadva_setf(int elt_idx, uint8_t txadva)
{
    ASSERT_ERR((((uint16_t)txadva << 8) & ~((uint16_t)0x00000100)) == 0);
...
__INLINE__ uint8_t em_ble_txaeheader_txaemode_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXAEHEADER_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x000000C0)) >> 6);
}

__INLINE__ void em_ble_txaeheader_txaemode_setf(int elt_idx, uint8_t txaemode)
{
    ASSERT_ERR((((uint16_t)txaemode << 6) & ~((uint16_t)0x000000C0)) == 0);
...
__INLINE__ uint8_t em_ble_txaeheader_txaelength_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXAEHEADER_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000003F)) >> 0);
}

__INLINE__ void em_ble_txaeheader_txaelength_setf(int elt_idx, uint8_t txaelength)
{
    ASSERT_ERR((((uint16_t)txaelength << 0) & ~((uint16_t)0x0000003F)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_TXAUXPTR0_ADDR   (EM_BASE_ADDR +0x08 + EM_BLE_TX_DESC_OFFSET)
#else
#define EM_BLE_TXAUXPTR0_ADDR   (0x50004008 + EM_BLE_TX_DESC_OFFSET)
#endif

#define EM_BLE_TXAUXPTR0_INDEX  0x00000004
#define EM_BLE_TXAUXPTR0_RESET  0x00000000

__INLINE__ uint16_t em_ble_txauxptr0_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXAUXPTR0_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
}

__INLINE__ void em_ble_txauxptr0_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_txauxptr0_pack(int elt_idx, uint8_t txauxoffsetlsb, uint8_t txauxoffsetunit, uint8_t txauxca, uint8_t txllch)
{
...
__INLINE__ void em_ble_txauxptr0_unpack(int elt_idx, uint8_t* txauxoffsetlsb, uint8_t* txauxoffsetunit, uint8_t* txauxca, uint8_t* txllch)
{
...
__INLINE__ uint8_t em_ble_txauxptr0_txauxoffset_lsb_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXAUXPTR0_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000FF00)) >> 8);
}

__INLINE__ void em_ble_txauxptr0_txauxoffset_lsb_setf(int elt_idx, uint8_t txauxoffsetlsb)
{
    ASSERT_ERR((((uint16_t)txauxoffsetlsb << 8) & ~((uint16_t)0x0000FF00)) == 0);
...
__INLINE__ uint8_t em_ble_txauxptr0_txauxoffset_unit_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXAUXPTR0_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000080)) >> 7);
}

__INLINE__ void em_ble_txauxptr0_txauxoffset_unit_setf(int elt_idx, uint8_t txauxoffsetunit)
{
    ASSERT_ERR((((uint16_t)txauxoffsetunit << 7) & ~((uint16_t)0x00000080)) == 0);
...
__INLINE__ uint8_t em_ble_txauxptr0_txaux_ca_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXAUXPTR0_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000040)) >> 6);
}

__INLINE__ void em_ble_txauxptr0_txaux_ca_setf(int elt_idx, uint8_t txauxca)
{
    ASSERT_ERR((((uint16_t)txauxca << 6) & ~((uint16_t)0x00000040)) == 0);
...
__INLINE__ uint8_t em_ble_txauxptr0_tx_ll_ch_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXAUXPTR0_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000003F)) >> 0);
}

__INLINE__ void em_ble_txauxptr0_tx_ll_ch_setf(int elt_idx, uint8_t txllch)
{
    ASSERT_ERR((((uint16_t)txllch << 0) & ~((uint16_t)0x0000003F)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_TXAUXPTR1_ADDR   (EM_BASE_ADDR +0x0A + EM_BLE_TX_DESC_OFFSET)
#else
#define EM_BLE_TXAUXPTR1_ADDR   (0x5000400A + EM_BLE_TX_DESC_OFFSET)
#endif

#define EM_BLE_TXAUXPTR1_INDEX  0x00000005
#define EM_BLE_TXAUXPTR1_RESET  0x00000000

__INLINE__ uint16_t em_ble_txauxptr1_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXAUXPTR1_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
}

__INLINE__ void em_ble_txauxptr1_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_txauxptr1_pack(int elt_idx, uint8_t txauxphy, uint8_t txauxoffsetmsb)
{
...
__INLINE__ void em_ble_txauxptr1_unpack(int elt_idx, uint8_t* txauxphy, uint8_t* txauxoffsetmsb)
{
...
__INLINE__ uint8_t em_ble_txauxptr1_txaux_phy_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXAUXPTR1_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x000000E0)) >> 5);
}

__INLINE__ void em_ble_txauxptr1_txaux_phy_setf(int elt_idx, uint8_t txauxphy)
{
    ASSERT_ERR((((uint16_t)txauxphy << 5) & ~((uint16_t)0x000000E0)) == 0);
...
__INLINE__ uint8_t em_ble_txauxptr1_txauxoffset_msb_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXAUXPTR1_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000001F)) >> 0);
}

__INLINE__ void em_ble_txauxptr1_txauxoffset_msb_setf(int elt_idx, uint8_t txauxoffsetmsb)
{
    ASSERT_ERR((((uint16_t)txauxoffsetmsb << 0) & ~((uint16_t)0x0000001F)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_TXAEDATAPTR_ADDR   (EM_BASE_ADDR +0x0C + EM_BLE_TX_DESC_OFFSET)
#else
#define EM_BLE_TXAEDATAPTR_ADDR   (0x5000400C + EM_BLE_TX_DESC_OFFSET)
#endif

#define EM_BLE_TXAEDATAPTR_INDEX  0x00000006
#define EM_BLE_TXAEDATAPTR_RESET  0x00000000

__INLINE__ uint16_t em_ble_txaedataptr_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXAEDATAPTR_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
}

__INLINE__ void em_ble_txaedataptr_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_txaedataptr_getf(int elt_idx)
{
...
__INLINE__ void em_ble_txaedataptr_setf(int elt_idx, uint16_t txaedataptr)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_TXPHCTE_ADDR   (EM_BASE_ADDR +0x0E + EM_BLE_TX_DESC_OFFSET)
#else
#define EM_BLE_TXPHCTE_ADDR   (0x5000400E + EM_BLE_TX_DESC_OFFSET)
#endif

#define EM_BLE_TXPHCTE_INDEX  0x00000007
#define EM_BLE_TXPHCTE_RESET  0x00000000

__INLINE__ uint16_t em_ble_txphcte_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXPHCTE_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
}

__INLINE__ void em_ble_txphcte_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_txphcte_pack(int elt_idx, uint8_t txctetype, uint8_t txcterfu, uint8_t txctetime)
{
...
__INLINE__ void em_ble_txphcte_unpack(int elt_idx, uint8_t* txctetype, uint8_t* txcterfu, uint8_t* txctetime)
{
...
__INLINE__ uint8_t em_ble_txphcte_txctetype_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXPHCTE_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x000000C0)) >> 6);
}

__INLINE__ void em_ble_txphcte_txctetype_setf(int elt_idx, uint8_t txctetype)
{
    ASSERT_ERR((((uint16_t)txctetype << 6) & ~((uint16_t)0x000000C0)) == 0);
...
__INLINE__ uint8_t em_ble_txphcte_txcterfu_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXPHCTE_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000020)) >> 5);
}

__INLINE__ void em_ble_txphcte_txcterfu_setf(int elt_idx, uint8_t txcterfu)
{
    ASSERT_ERR((((uint16_t)txcterfu << 5) & ~((uint16_t)0x00000020)) == 0);
...
__INLINE__ uint8_t em_ble_txphcte_txctetime_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXPHCTE_ADDR + elt_idx * REG_EM_BLE_TX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000001F)) >> 0);
}

__INLINE__ void em_ble_txphcte_txctetime_setf(int elt_idx, uint8_t txctetime)
{
    ASSERT_ERR((((uint16_t)txctetime << 0) & ~((uint16_t)0x0000001F)) == 0);
