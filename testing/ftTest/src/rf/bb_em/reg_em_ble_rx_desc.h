...
#define EM_BLE_RXCNTL_ADDR   (EM_BASE_ADDR + EM_BLE_RX_DESC_OFFSET)
#else
#define EM_BLE_RXCNTL_ADDR   (0x50004000 + EM_BLE_RX_DESC_OFFSET)
#endif

#define EM_BLE_RXCNTL_INDEX  0x00000000
#define EM_BLE_RXCNTL_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxcntl_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXCNTL_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
}

__INLINE__ void em_ble_rxcntl_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_rxcntl_pack(int elt_idx, uint8_t rxdone, uint16_t rxnextptr)
{
...
__INLINE__ void em_ble_rxcntl_unpack(int elt_idx, uint8_t* rxdone, uint16_t* rxnextptr)
{
...
__INLINE__ uint8_t em_ble_rxcntl_rxdone_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXCNTL_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__INLINE__ void em_ble_rxcntl_rxdone_setf(int elt_idx, uint8_t rxdone)
{
    ASSERT_ERR((((uint16_t)rxdone << 15) & ~((uint16_t)0x00008000)) == 0);
...
__INLINE__ uint16_t em_ble_rxcntl_rxnextptr_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXCNTL_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00003FFF)) >> 0);
}

__INLINE__ void em_ble_rxcntl_rxnextptr_setf(int elt_idx, uint16_t rxnextptr)
{
    ASSERT_ERR((((uint16_t)rxnextptr << 0) & ~((uint16_t)0x00003FFF)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXSTATCE_ADDR   (EM_BASE_ADDR + 0x02 + EM_BLE_RX_DESC_OFFSET)
#else
#define EM_BLE_RXSTATCE_ADDR   (0x50004002 + EM_BLE_RX_DESC_OFFSET)
#endif

#define EM_BLE_RXSTATCE_INDEX  0x00000001
#define EM_BLE_RXSTATCE_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxstatce_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXSTATCE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
}

__INLINE__ void em_ble_rxstatce_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_rxstatce_pack(int elt_idx, uint8_t rxcteerr, uint8_t nesnerr, uint8_t snerr, uint8_t lliderr, uint8_t micerr, uint8_t crcerr, uint8_t lenerr, uint8_t rxtimeerr, uint8_t syncerr)
{
...
__INLINE__ void em_ble_rxstatce_unpack(int elt_idx, uint8_t* rxcteerr, uint8_t* nesnerr, uint8_t* snerr, uint8_t* lliderr, uint8_t* micerr, uint8_t* crcerr, uint8_t* lenerr, uint8_t* rxtimeerr, uint8_t* syncerr)
{
...
__INLINE__ uint8_t em_ble_rxstatce_rxcteerr_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATCE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__INLINE__ void em_ble_rxstatce_rxcteerr_setf(int elt_idx, uint8_t rxcteerr)
{
    ASSERT_ERR((((uint16_t)rxcteerr << 15) & ~((uint16_t)0x00008000)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatce_nesn_err_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATCE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000080)) >> 7);
}

__INLINE__ void em_ble_rxstatce_nesn_err_setf(int elt_idx, uint8_t nesnerr)
{
    ASSERT_ERR((((uint16_t)nesnerr << 7) & ~((uint16_t)0x00000080)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatce_sn_err_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATCE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000040)) >> 6);
}

__INLINE__ void em_ble_rxstatce_sn_err_setf(int elt_idx, uint8_t snerr)
{
    ASSERT_ERR((((uint16_t)snerr << 6) & ~((uint16_t)0x00000040)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatce_llid_err_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATCE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000020)) >> 5);
}

__INLINE__ void em_ble_rxstatce_llid_err_setf(int elt_idx, uint8_t lliderr)
{
    ASSERT_ERR((((uint16_t)lliderr << 5) & ~((uint16_t)0x00000020)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatce_mic_err_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATCE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000010)) >> 4);
}

__INLINE__ void em_ble_rxstatce_mic_err_setf(int elt_idx, uint8_t micerr)
{
    ASSERT_ERR((((uint16_t)micerr << 4) & ~((uint16_t)0x00000010)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatce_crc_err_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATCE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000008)) >> 3);
}

__INLINE__ void em_ble_rxstatce_crc_err_setf(int elt_idx, uint8_t crcerr)
{
    ASSERT_ERR((((uint16_t)crcerr << 3) & ~((uint16_t)0x00000008)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatce_len_err_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATCE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000004)) >> 2);
}

__INLINE__ void em_ble_rxstatce_len_err_setf(int elt_idx, uint8_t lenerr)
{
    ASSERT_ERR((((uint16_t)lenerr << 2) & ~((uint16_t)0x00000004)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatce_rxtime_err_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATCE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000002)) >> 1);
}

__INLINE__ void em_ble_rxstatce_rxtime_err_setf(int elt_idx, uint8_t rxtimeerr)
{
    ASSERT_ERR((((uint16_t)rxtimeerr << 1) & ~((uint16_t)0x00000002)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatce_sync_err_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATCE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000001)) >> 0);
}

__INLINE__ void em_ble_rxstatce_sync_err_setf(int elt_idx, uint8_t syncerr)
{
    ASSERT_ERR((((uint16_t)syncerr << 0) & ~((uint16_t)0x00000001)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXSTATADV_ADDR   (EM_BASE_ADDR + 0x02 + EM_BLE_RX_DESC_OFFSET)
#else
#define EM_BLE_RXSTATADV_ADDR   (0x50004002 + EM_BLE_RX_DESC_OFFSET)
#endif

#define EM_BLE_RXSTATADV_INDEX  0x00000001
#define EM_BLE_RXSTATADV_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxstatadv_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXSTATADV_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
}

__INLINE__ void em_ble_rxstatadv_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_rxstatadv_pack(int elt_idx, uint8_t rxcteerr, uint8_t followauxptr, uint8_t devfilteringok, uint8_t inwhl, uint8_t inperadval, uint8_t peeraddmatch, uint8_t bdaddrmatch, uint8_t typeerr, uint8_t priverr, uint8_t crcerr, uint8_t lenerr, uint8_t rxtimeerr, uint8_t syncerr)
{
    ASSERT_ERR((((uint16_t)rxcteerr << 15) & ~((uint16_t)0x00008000)) == 0);
...
__INLINE__ void em_ble_rxstatadv_unpack(int elt_idx, uint8_t* rxcteerr, uint8_t* followauxptr, uint8_t* devfilteringok, uint8_t* inwhl, uint8_t* inperadval, uint8_t* peeraddmatch, uint8_t* bdaddrmatch, uint8_t* typeerr, uint8_t* priverr, uint8_t* crcerr, uint8_t* lenerr, uint8_t* rxtimeerr, uint8_t* syncerr)
{
...
__INLINE__ uint8_t em_ble_rxstatadv_rxcteerr_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATADV_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__INLINE__ void em_ble_rxstatadv_rxcteerr_setf(int elt_idx, uint8_t rxcteerr)
{
    ASSERT_ERR((((uint16_t)rxcteerr << 15) & ~((uint16_t)0x00008000)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatadv_followauxptr_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATADV_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000800)) >> 11);
}

__INLINE__ void em_ble_rxstatadv_followauxptr_setf(int elt_idx, uint8_t followauxptr)
{
    ASSERT_ERR((((uint16_t)followauxptr << 11) & ~((uint16_t)0x00000800)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatadv_dev_filtering_ok_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATADV_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000400)) >> 10);
}

__INLINE__ void em_ble_rxstatadv_dev_filtering_ok_setf(int elt_idx, uint8_t devfilteringok)
{
    ASSERT_ERR((((uint16_t)devfilteringok << 10) & ~((uint16_t)0x00000400)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatadv_in_whl_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATADV_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000200)) >> 9);
}

__INLINE__ void em_ble_rxstatadv_in_whl_setf(int elt_idx, uint8_t inwhl)
{
    ASSERT_ERR((((uint16_t)inwhl << 9) & ~((uint16_t)0x00000200)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatadv_in_peradval_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATADV_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000100)) >> 8);
}

__INLINE__ void em_ble_rxstatadv_in_peradval_setf(int elt_idx, uint8_t inperadval)
{
    ASSERT_ERR((((uint16_t)inperadval << 8) & ~((uint16_t)0x00000100)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatadv_peer_add_match_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATADV_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000080)) >> 7);
}

__INLINE__ void em_ble_rxstatadv_peer_add_match_setf(int elt_idx, uint8_t peeraddmatch)
{
    ASSERT_ERR((((uint16_t)peeraddmatch << 7) & ~((uint16_t)0x00000080)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatadv_bdaddr_match_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATADV_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000040)) >> 6);
}

__INLINE__ void em_ble_rxstatadv_bdaddr_match_setf(int elt_idx, uint8_t bdaddrmatch)
{
    ASSERT_ERR((((uint16_t)bdaddrmatch << 6) & ~((uint16_t)0x00000040)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatadv_type_err_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATADV_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000020)) >> 5);
}

__INLINE__ void em_ble_rxstatadv_type_err_setf(int elt_idx, uint8_t typeerr)
{
    ASSERT_ERR((((uint16_t)typeerr << 5) & ~((uint16_t)0x00000020)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatadv_priv_err_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATADV_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000010)) >> 4);
}

__INLINE__ void em_ble_rxstatadv_priv_err_setf(int elt_idx, uint8_t priverr)
{
    ASSERT_ERR((((uint16_t)priverr << 4) & ~((uint16_t)0x00000010)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatadv_crc_err_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATADV_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000008)) >> 3);
}

__INLINE__ void em_ble_rxstatadv_crc_err_setf(int elt_idx, uint8_t crcerr)
{
    ASSERT_ERR((((uint16_t)crcerr << 3) & ~((uint16_t)0x00000008)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatadv_len_err_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATADV_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000004)) >> 2);
}

__INLINE__ void em_ble_rxstatadv_len_err_setf(int elt_idx, uint8_t lenerr)
{
    ASSERT_ERR((((uint16_t)lenerr << 2) & ~((uint16_t)0x00000004)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatadv_rxtime_err_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATADV_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000002)) >> 1);
}

__INLINE__ void em_ble_rxstatadv_rxtime_err_setf(int elt_idx, uint8_t rxtimeerr)
{
    ASSERT_ERR((((uint16_t)rxtimeerr << 1) & ~((uint16_t)0x00000002)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatadv_sync_err_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATADV_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000001)) >> 0);
}

__INLINE__ void em_ble_rxstatadv_sync_err_setf(int elt_idx, uint8_t syncerr)
{
    ASSERT_ERR((((uint16_t)syncerr << 0) & ~((uint16_t)0x00000001)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXSTATISOM0_ADDR   (EM_BASE_ADDR + 0x02 + EM_BLE_RX_DESC_OFFSET)
#else
#define EM_BLE_RXSTATISOM0_ADDR   (0x50004002 + EM_BLE_RX_DESC_OFFSET)
#endif

#define EM_BLE_RXSTATISOM0_INDEX  0x00000001
#define EM_BLE_RXSTATISOM0_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxstatisom0_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXSTATISOM0_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
}

__INLINE__ void em_ble_rxstatisom0_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_rxstatisom0_pack(int elt_idx, uint8_t rxstreamlbl, uint8_t rxgrouplbl, uint8_t nesnerr, uint8_t snerr, uint8_t lliderr, uint8_t micerr, uint8_t crcerr, uint8_t lenerr, uint8_t rxtimeerr, uint8_t syncerr)
{
...
__INLINE__ void em_ble_rxstatisom0_unpack(int elt_idx, uint8_t* rxstreamlbl, uint8_t* rxgrouplbl, uint8_t* nesnerr, uint8_t* snerr, uint8_t* lliderr, uint8_t* micerr, uint8_t* crcerr, uint8_t* lenerr, uint8_t* rxtimeerr, uint8_t* syncerr)
{
...
__INLINE__ uint8_t em_ble_rxstatisom0_rxstream_lbl_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATISOM0_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000F800)) >> 11);
}

__INLINE__ void em_ble_rxstatisom0_rxstream_lbl_setf(int elt_idx, uint8_t rxstreamlbl)
{
    ASSERT_ERR((((uint16_t)rxstreamlbl << 11) & ~((uint16_t)0x0000F800)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatisom0_rxgroup_lbl_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATISOM0_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000700)) >> 8);
}

__INLINE__ void em_ble_rxstatisom0_rxgroup_lbl_setf(int elt_idx, uint8_t rxgrouplbl)
{
    ASSERT_ERR((((uint16_t)rxgrouplbl << 8) & ~((uint16_t)0x00000700)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatisom0_nesn_err_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATISOM0_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000080)) >> 7);
}

__INLINE__ void em_ble_rxstatisom0_nesn_err_setf(int elt_idx, uint8_t nesnerr)
{
    ASSERT_ERR((((uint16_t)nesnerr << 7) & ~((uint16_t)0x00000080)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatisom0_sn_err_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATISOM0_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000040)) >> 6);
}

__INLINE__ void em_ble_rxstatisom0_sn_err_setf(int elt_idx, uint8_t snerr)
{
    ASSERT_ERR((((uint16_t)snerr << 6) & ~((uint16_t)0x00000040)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatisom0_llid_err_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATISOM0_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000020)) >> 5);
}

__INLINE__ void em_ble_rxstatisom0_llid_err_setf(int elt_idx, uint8_t lliderr)
{
    ASSERT_ERR((((uint16_t)lliderr << 5) & ~((uint16_t)0x00000020)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatisom0_mic_err_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATISOM0_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000010)) >> 4);
}

__INLINE__ void em_ble_rxstatisom0_mic_err_setf(int elt_idx, uint8_t micerr)
{
    ASSERT_ERR((((uint16_t)micerr << 4) & ~((uint16_t)0x00000010)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatisom0_crc_err_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATISOM0_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000008)) >> 3);
}

__INLINE__ void em_ble_rxstatisom0_crc_err_setf(int elt_idx, uint8_t crcerr)
{
    ASSERT_ERR((((uint16_t)crcerr << 3) & ~((uint16_t)0x00000008)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatisom0_len_err_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATISOM0_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000004)) >> 2);
}

__INLINE__ void em_ble_rxstatisom0_len_err_setf(int elt_idx, uint8_t lenerr)
{
    ASSERT_ERR((((uint16_t)lenerr << 2) & ~((uint16_t)0x00000004)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatisom0_rxtime_err_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATISOM0_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000002)) >> 1);
}

__INLINE__ void em_ble_rxstatisom0_rxtime_err_setf(int elt_idx, uint8_t rxtimeerr)
{
    ASSERT_ERR((((uint16_t)rxtimeerr << 1) & ~((uint16_t)0x00000002)) == 0);
...
__INLINE__ uint8_t em_ble_rxstatisom0_sync_err_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXSTATISOM0_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000001)) >> 0);
}

__INLINE__ void em_ble_rxstatisom0_sync_err_setf(int elt_idx, uint8_t syncerr)
{
    ASSERT_ERR((((uint16_t)syncerr << 0) & ~((uint16_t)0x00000001)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXPHCE_ADDR   (EM_BASE_ADDR + 0x04 + EM_BLE_RX_DESC_OFFSET)
#else
#define EM_BLE_RXPHCE_ADDR   (0x50004004 + EM_BLE_RX_DESC_OFFSET)
#endif

#define EM_BLE_RXPHCE_INDEX  0x00000002
#define EM_BLE_RXPHCE_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxphce_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXPHCE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
}

__INLINE__ void em_ble_rxphce_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_rxphce_pack(int elt_idx, uint8_t rxlen, uint8_t rxaclrfu, uint8_t rxcp, uint8_t rxmd, uint8_t rxsn, uint8_t rxnesn, uint8_t rxllid)
{
...
__INLINE__ void em_ble_rxphce_unpack(int elt_idx, uint8_t* rxlen, uint8_t* rxaclrfu, uint8_t* rxcp, uint8_t* rxmd, uint8_t* rxsn, uint8_t* rxnesn, uint8_t* rxllid)
{
...
__INLINE__ uint8_t em_ble_rxphce_rxlen_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHCE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000FF00)) >> 8);
}

__INLINE__ void em_ble_rxphce_rxlen_setf(int elt_idx, uint8_t rxlen)
{
    ASSERT_ERR((((uint16_t)rxlen << 8) & ~((uint16_t)0x0000FF00)) == 0);
...
__INLINE__ uint8_t em_ble_rxphce_rxaclrfu_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHCE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x000000C0)) >> 6);
}

__INLINE__ void em_ble_rxphce_rxaclrfu_setf(int elt_idx, uint8_t rxaclrfu)
{
    ASSERT_ERR((((uint16_t)rxaclrfu << 6) & ~((uint16_t)0x000000C0)) == 0);
...
__INLINE__ uint8_t em_ble_rxphce_rxcp_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHCE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000020)) >> 5);
}

__INLINE__ void em_ble_rxphce_rxcp_setf(int elt_idx, uint8_t rxcp)
{
    ASSERT_ERR((((uint16_t)rxcp << 5) & ~((uint16_t)0x00000020)) == 0);
...
__INLINE__ uint8_t em_ble_rxphce_rxmd_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHCE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000010)) >> 4);
}

__INLINE__ void em_ble_rxphce_rxmd_setf(int elt_idx, uint8_t rxmd)
{
    ASSERT_ERR((((uint16_t)rxmd << 4) & ~((uint16_t)0x00000010)) == 0);
...
__INLINE__ uint8_t em_ble_rxphce_rxsn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHCE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000008)) >> 3);
}

__INLINE__ void em_ble_rxphce_rxsn_setf(int elt_idx, uint8_t rxsn)
{
    ASSERT_ERR((((uint16_t)rxsn << 3) & ~((uint16_t)0x00000008)) == 0);
...
__INLINE__ uint8_t em_ble_rxphce_rxnesn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHCE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000004)) >> 2);
}

__INLINE__ void em_ble_rxphce_rxnesn_setf(int elt_idx, uint8_t rxnesn)
{
    ASSERT_ERR((((uint16_t)rxnesn << 2) & ~((uint16_t)0x00000004)) == 0);
...
__INLINE__ uint8_t em_ble_rxphce_rxllid_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHCE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000003)) >> 0);
}

__INLINE__ void em_ble_rxphce_rxllid_setf(int elt_idx, uint8_t rxllid)
{
    ASSERT_ERR((((uint16_t)rxllid << 0) & ~((uint16_t)0x00000003)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXPHADV_ADDR   (EM_BASE_ADDR + 0x04 + EM_BLE_RX_DESC_OFFSET)
#else
#define EM_BLE_RXPHADV_ADDR   (0x50004004 + EM_BLE_RX_DESC_OFFSET)
#endif

#define EM_BLE_RXPHADV_INDEX  0x00000002
#define EM_BLE_RXPHADV_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxphadv_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXPHADV_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
}

__INLINE__ void em_ble_rxphadv_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_rxphadv_pack(int elt_idx, uint8_t rxadvlen, uint8_t rxrxadd, uint8_t rxtxadd, uint8_t rxchsel2, uint8_t rxadvrfu, uint8_t rxtype)
{
...
__INLINE__ void em_ble_rxphadv_unpack(int elt_idx, uint8_t* rxadvlen, uint8_t* rxrxadd, uint8_t* rxtxadd, uint8_t* rxchsel2, uint8_t* rxadvrfu, uint8_t* rxtype)
{
...
__INLINE__ uint8_t em_ble_rxphadv_rxadvlen_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHADV_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000FF00)) >> 8);
}

__INLINE__ void em_ble_rxphadv_rxadvlen_setf(int elt_idx, uint8_t rxadvlen)
{
    ASSERT_ERR((((uint16_t)rxadvlen << 8) & ~((uint16_t)0x0000FF00)) == 0);
...
__INLINE__ uint8_t em_ble_rxphadv_rxrxadd_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHADV_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000080)) >> 7);
}

__INLINE__ void em_ble_rxphadv_rxrxadd_setf(int elt_idx, uint8_t rxrxadd)
{
    ASSERT_ERR((((uint16_t)rxrxadd << 7) & ~((uint16_t)0x00000080)) == 0);
...
__INLINE__ uint8_t em_ble_rxphadv_rxtxadd_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHADV_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000040)) >> 6);
}

__INLINE__ void em_ble_rxphadv_rxtxadd_setf(int elt_idx, uint8_t rxtxadd)
{
    ASSERT_ERR((((uint16_t)rxtxadd << 6) & ~((uint16_t)0x00000040)) == 0);
...
__INLINE__ uint8_t em_ble_rxphadv_rxchsel2_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHADV_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000020)) >> 5);
}

__INLINE__ void em_ble_rxphadv_rxchsel2_setf(int elt_idx, uint8_t rxchsel2)
{
    ASSERT_ERR((((uint16_t)rxchsel2 << 5) & ~((uint16_t)0x00000020)) == 0);
...
__INLINE__ uint8_t em_ble_rxphadv_rxadvrfu_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHADV_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000010)) >> 4);
}

__INLINE__ void em_ble_rxphadv_rxadvrfu_setf(int elt_idx, uint8_t rxadvrfu)
{
    ASSERT_ERR((((uint16_t)rxadvrfu << 4) & ~((uint16_t)0x00000010)) == 0);
...
__INLINE__ uint8_t em_ble_rxphadv_rxtype_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHADV_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000000F)) >> 0);
}

__INLINE__ void em_ble_rxphadv_rxtype_setf(int elt_idx, uint8_t rxtype)
{
    ASSERT_ERR((((uint16_t)rxtype << 0) & ~((uint16_t)0x0000000F)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXPHISOM0_ADDR   (EM_BASE_ADDR + 0x04 + EM_BLE_RX_DESC_OFFSET)
#else
#define EM_BLE_RXPHISOM0_ADDR   (0x50004004 + EM_BLE_RX_DESC_OFFSET)
#endif

#define EM_BLE_RXPHISOM0_INDEX  0x00000002
#define EM_BLE_RXPHISOM0_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxphisom0_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXPHISOM0_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
}

__INLINE__ void em_ble_rxphisom0_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_rxphisom0_pack(int elt_idx, uint8_t rxlen, uint8_t rxisom0rfu, uint8_t rxmd, uint8_t rxsn, uint8_t rxnesn, uint8_t rxllid)
{
    ASSERT_ERR((((uint16_t)rxlen << 8) & ~((uint16_t)0x0000FF00)) == 0);
...
__INLINE__ void em_ble_rxphisom0_unpack(int elt_idx, uint8_t* rxlen, uint8_t* rxisom0rfu, uint8_t* rxmd, uint8_t* rxsn, uint8_t* rxnesn, uint8_t* rxllid)
{
...
__INLINE__ uint8_t em_ble_rxphisom0_rxlen_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHISOM0_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000FF00)) >> 8);
}

__INLINE__ void em_ble_rxphisom0_rxlen_setf(int elt_idx, uint8_t rxlen)
{
    ASSERT_ERR((((uint16_t)rxlen << 8) & ~((uint16_t)0x0000FF00)) == 0);
...
__INLINE__ uint8_t em_ble_rxphisom0_rxisom0rfu_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHISOM0_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x000000E0)) >> 5);
}

__INLINE__ void em_ble_rxphisom0_rxisom0rfu_setf(int elt_idx, uint8_t rxisom0rfu)
{
    ASSERT_ERR((((uint16_t)rxisom0rfu << 5) & ~((uint16_t)0x000000E0)) == 0);
...
__INLINE__ uint8_t em_ble_rxphisom0_rxmd_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHISOM0_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000010)) >> 4);
}

__INLINE__ void em_ble_rxphisom0_rxmd_setf(int elt_idx, uint8_t rxmd)
{
    ASSERT_ERR((((uint16_t)rxmd << 4) & ~((uint16_t)0x00000010)) == 0);
...
__INLINE__ uint8_t em_ble_rxphisom0_rxsn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHISOM0_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000008)) >> 3);
}

__INLINE__ void em_ble_rxphisom0_rxsn_setf(int elt_idx, uint8_t rxsn)
{
    ASSERT_ERR((((uint16_t)rxsn << 3) & ~((uint16_t)0x00000008)) == 0);
...
__INLINE__ uint8_t em_ble_rxphisom0_rxnesn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHISOM0_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000004)) >> 2);
}

__INLINE__ void em_ble_rxphisom0_rxnesn_setf(int elt_idx, uint8_t rxnesn)
{
    ASSERT_ERR((((uint16_t)rxnesn << 2) & ~((uint16_t)0x00000004)) == 0);
...
__INLINE__ uint8_t em_ble_rxphisom0_rxllid_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHISOM0_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000003)) >> 0);
}

__INLINE__ void em_ble_rxphisom0_rxllid_setf(int elt_idx, uint8_t rxllid)
{
    ASSERT_ERR((((uint16_t)rxllid << 0) & ~((uint16_t)0x00000003)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXCHASS_ADDR   (EM_BASE_ADDR + 0x06 + EM_BLE_RX_DESC_OFFSET)
#else
#define EM_BLE_RXCHASS_ADDR   (0x50004006 + EM_BLE_RX_DESC_OFFSET)
#endif

#define EM_BLE_RXCHASS_INDEX  0x00000003
#define EM_BLE_RXCHASS_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxchass_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXCHASS_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
}

__INLINE__ void em_ble_rxchass_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_rxchass_pack(int elt_idx, uint8_t rate, uint8_t usedchidx, uint8_t rssi)
{
...
__INLINE__ void em_ble_rxchass_unpack(int elt_idx, uint8_t* rate, uint8_t* usedchidx, uint8_t* rssi)
{
...
__INLINE__ uint8_t em_ble_rxchass_rate_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXCHASS_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000C000)) >> 14);
}

__INLINE__ void em_ble_rxchass_rate_setf(int elt_idx, uint8_t rate)
{
    ASSERT_ERR((((uint16_t)rate << 14) & ~((uint16_t)0x0000C000)) == 0);
...
__INLINE__ uint8_t em_ble_rxchass_used_ch_idx_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXCHASS_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00003F00)) >> 8);
}

__INLINE__ void em_ble_rxchass_used_ch_idx_setf(int elt_idx, uint8_t usedchidx)
{
    ASSERT_ERR((((uint16_t)usedchidx << 8) & ~((uint16_t)0x00003F00)) == 0);
...
__INLINE__ uint8_t em_ble_rxchass_rssi_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXCHASS_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x000000FF)) >> 0);
}

__INLINE__ void em_ble_rxchass_rssi_setf(int elt_idx, uint8_t rssi)
{
    ASSERT_ERR((((uint16_t)rssi << 0) & ~((uint16_t)0x000000FF)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXCLKNSYNC0_ADDR   (EM_BASE_ADDR + 0x08 + EM_BLE_RX_DESC_OFFSET)
#else
#define EM_BLE_RXCLKNSYNC0_ADDR   (0x50004008 + EM_BLE_RX_DESC_OFFSET)
#endif

#define EM_BLE_RXCLKNSYNC0_INDEX  0x00000004
#define EM_BLE_RXCLKNSYNC0_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxclknsync0_get(int elt_idx)
{
...
__INLINE__ uint16_t em_ble_rxclknsync0_clknrxsync0_getf(int elt_idx)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXCLKNSYNC1_ADDR   (EM_BASE_ADDR + 0x0A + EM_BLE_RX_DESC_OFFSET)
#else
#define EM_BLE_RXCLKNSYNC1_ADDR   (0x5000400A + EM_BLE_RX_DESC_OFFSET)
#endif

#define EM_BLE_RXCLKNSYNC1_INDEX  0x00000005
#define EM_BLE_RXCLKNSYNC1_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxclknsync1_get(int elt_idx)
{
...
__INLINE__ uint16_t em_ble_rxclknsync1_clknrxsync1_getf(int elt_idx)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXFCNTSYNC_ADDR   (EM_BASE_ADDR + 0x0C + EM_BLE_RX_DESC_OFFSET)
#else
#define EM_BLE_RXFCNTSYNC_ADDR   (0x5000400C + EM_BLE_RX_DESC_OFFSET)
#endif

#define EM_BLE_RXFCNTSYNC_INDEX  0x00000006
#define EM_BLE_RXFCNTSYNC_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxfcntsync_get(int elt_idx)
{
...
__INLINE__ void em_ble_rxfcntsync_unpack(int elt_idx, uint8_t* rxlinklbl, uint16_t* fcntrxsync)
{
...
__INLINE__ uint8_t em_ble_rxfcntsync_rxlinklbl_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXFCNTSYNC_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000F800)) >> 11);
}

__INLINE__ uint16_t em_ble_rxfcntsync_fcntrxsync_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXFCNTSYNC_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXWPALPTR_ADDR   (EM_BASE_ADDR + 0x0E + EM_BLE_RX_DESC_OFFSET)
#else
#define EM_BLE_RXWPALPTR_ADDR   (0x5000400E + EM_BLE_RX_DESC_OFFSET)
#endif

#define EM_BLE_RXWPALPTR_INDEX  0x00000007
#define EM_BLE_RXWPALPTR_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxwpalptr_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXWPALPTR_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
}

__INLINE__ void em_ble_rxwpalptr_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_rxwpalptr_getf(int elt_idx)
{
...
__INLINE__ void em_ble_rxwpalptr_setf(int elt_idx, uint16_t rxwpalptr)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXRALPTR_ADDR   (EM_BASE_ADDR + 0x10 + EM_BLE_RX_DESC_OFFSET)
#else
#define EM_BLE_RXRALPTR_ADDR   (0x50004010 + EM_BLE_RX_DESC_OFFSET)
#endif

#define EM_BLE_RXRALPTR_INDEX  0x00000008
#define EM_BLE_RXRALPTR_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxralptr_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXRALPTR_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
}

__INLINE__ void em_ble_rxralptr_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_rxralptr_getf(int elt_idx)
{
...
__INLINE__ void em_ble_rxralptr_setf(int elt_idx, uint16_t rxralptr)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXAEHEADER_ADDR   (EM_BASE_ADDR + 0x12 + EM_BLE_RX_DESC_OFFSET)
#else
#define EM_BLE_RXAEHEADER_ADDR   (0x50004012 + EM_BLE_RX_DESC_OFFSET)
#endif

#define EM_BLE_RXAEHEADER_INDEX  0x00000009
#define EM_BLE_RXAEHEADER_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxaeheader_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXAEHEADER_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
}

__INLINE__ void em_ble_rxaeheader_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_rxaeheader_pack(int elt_idx, uint8_t rxrsvd, uint8_t rxpow, uint8_t rxsync, uint8_t rxauxptr, uint8_t rxadi, uint8_t rxcte, uint8_t rxtgta, uint8_t rxadva, uint8_t rxaemode, uint8_t rxaelength)
{
...
__INLINE__ void em_ble_rxaeheader_unpack(int elt_idx, uint8_t* rxrsvd, uint8_t* rxpow, uint8_t* rxsync, uint8_t* rxauxptr, uint8_t* rxadi, uint8_t* rxcte, uint8_t* rxtgta, uint8_t* rxadva, uint8_t* rxaemode, uint8_t* rxaelength)
{
...
__INLINE__ uint8_t em_ble_rxaeheader_rxrsvd_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXAEHEADER_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__INLINE__ void em_ble_rxaeheader_rxrsvd_setf(int elt_idx, uint8_t rxrsvd)
{
    ASSERT_ERR((((uint16_t)rxrsvd << 15) & ~((uint16_t)0x00008000)) == 0);
...
__INLINE__ uint8_t em_ble_rxaeheader_rxpow_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXAEHEADER_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00004000)) >> 14);
}

__INLINE__ void em_ble_rxaeheader_rxpow_setf(int elt_idx, uint8_t rxpow)
{
    ASSERT_ERR((((uint16_t)rxpow << 14) & ~((uint16_t)0x00004000)) == 0);
...
__INLINE__ uint8_t em_ble_rxaeheader_rxsync_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXAEHEADER_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00002000)) >> 13);
}

__INLINE__ void em_ble_rxaeheader_rxsync_setf(int elt_idx, uint8_t rxsync)
{
    ASSERT_ERR((((uint16_t)rxsync << 13) & ~((uint16_t)0x00002000)) == 0);
...
__INLINE__ uint8_t em_ble_rxaeheader_rxauxptr_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXAEHEADER_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00001000)) >> 12);
}

__INLINE__ void em_ble_rxaeheader_rxauxptr_setf(int elt_idx, uint8_t rxauxptr)
{
    ASSERT_ERR((((uint16_t)rxauxptr << 12) & ~((uint16_t)0x00001000)) == 0);
...
__INLINE__ uint8_t em_ble_rxaeheader_rxadi_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXAEHEADER_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000800)) >> 11);
}

__INLINE__ void em_ble_rxaeheader_rxadi_setf(int elt_idx, uint8_t rxadi)
{
    ASSERT_ERR((((uint16_t)rxadi << 11) & ~((uint16_t)0x00000800)) == 0);
...
__INLINE__ uint8_t em_ble_rxaeheader_rxcte_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXAEHEADER_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000400)) >> 10);
}

__INLINE__ void em_ble_rxaeheader_rxcte_setf(int elt_idx, uint8_t rxcte)
{
    ASSERT_ERR((((uint16_t)rxcte << 10) & ~((uint16_t)0x00000400)) == 0);
...
__INLINE__ uint8_t em_ble_rxaeheader_rxtgta_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXAEHEADER_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000200)) >> 9);
}

__INLINE__ void em_ble_rxaeheader_rxtgta_setf(int elt_idx, uint8_t rxtgta)
{
    ASSERT_ERR((((uint16_t)rxtgta << 9) & ~((uint16_t)0x00000200)) == 0);
...
__INLINE__ uint8_t em_ble_rxaeheader_rxadva_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXAEHEADER_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000100)) >> 8);
}

__INLINE__ void em_ble_rxaeheader_rxadva_setf(int elt_idx, uint8_t rxadva)
{
    ASSERT_ERR((((uint16_t)rxadva << 8) & ~((uint16_t)0x00000100)) == 0);
...
__INLINE__ uint8_t em_ble_rxaeheader_rxaemode_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXAEHEADER_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x000000C0)) >> 6);
}

__INLINE__ void em_ble_rxaeheader_rxaemode_setf(int elt_idx, uint8_t rxaemode)
{
    ASSERT_ERR((((uint16_t)rxaemode << 6) & ~((uint16_t)0x000000C0)) == 0);
...
__INLINE__ uint8_t em_ble_rxaeheader_rxaelength_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXAEHEADER_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000003F)) >> 0);
}

__INLINE__ void em_ble_rxaeheader_rxaelength_setf(int elt_idx, uint8_t rxaelength)
{
    ASSERT_ERR((((uint16_t)rxaelength << 0) & ~((uint16_t)0x0000003F)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXDATAPTR_ADDR   (EM_BASE_ADDR + 0x14 + EM_BLE_RX_DESC_OFFSET)
#else
#define EM_BLE_RXDATAPTR_ADDR   (0x50004014 + EM_BLE_RX_DESC_OFFSET)
#endif

#define EM_BLE_RXDATAPTR_INDEX  0x0000000A
#define EM_BLE_RXDATAPTR_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxdataptr_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXDATAPTR_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
}

__INLINE__ void em_ble_rxdataptr_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_rxdataptr_getf(int elt_idx)
{
...
__INLINE__ void em_ble_rxdataptr_setf(int elt_idx, uint16_t rxdataptr)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXPHCTE_ADDR   (EM_BASE_ADDR + 0x16 + EM_BLE_RX_DESC_OFFSET)
#else
#define EM_BLE_RXPHCTE_ADDR   (0x50004016 + EM_BLE_RX_DESC_OFFSET)
#endif

#define EM_BLE_RXPHCTE_INDEX  0x0000000B
#define EM_BLE_RXPHCTE_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxphcte_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXPHCTE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
}

__INLINE__ void em_ble_rxphcte_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_rxphcte_pack(int elt_idx, uint8_t nbrxiqsamp, uint8_t rxctetype, uint8_t rxcterfu, uint8_t rxctetime)
{
...
__INLINE__ void em_ble_rxphcte_unpack(int elt_idx, uint8_t* nbrxiqsamp, uint8_t* rxctetype, uint8_t* rxcterfu, uint8_t* rxctetime)
{
...
__INLINE__ uint8_t em_ble_rxphcte_nbrxiqsamp_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHCTE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000FF00)) >> 8);
}

__INLINE__ void em_ble_rxphcte_nbrxiqsamp_setf(int elt_idx, uint8_t nbrxiqsamp)
{
    ASSERT_ERR((((uint16_t)nbrxiqsamp << 8) & ~((uint16_t)0x0000FF00)) == 0);
...
__INLINE__ uint8_t em_ble_rxphcte_rxctetype_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHCTE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x000000C0)) >> 6);
}

__INLINE__ void em_ble_rxphcte_rxctetype_setf(int elt_idx, uint8_t rxctetype)
{
    ASSERT_ERR((((uint16_t)rxctetype << 6) & ~((uint16_t)0x000000C0)) == 0);
...
__INLINE__ uint8_t em_ble_rxphcte_rxcterfu_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHCTE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000020)) >> 5);
}

__INLINE__ void em_ble_rxphcte_rxcterfu_setf(int elt_idx, uint8_t rxcterfu)
{
    ASSERT_ERR((((uint16_t)rxcterfu << 5) & ~((uint16_t)0x00000020)) == 0);
...
__INLINE__ uint8_t em_ble_rxphcte_rxctetime_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXPHCTE_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000001F)) >> 0);
}

__INLINE__ void em_ble_rxphcte_rxctetime_setf(int elt_idx, uint8_t rxctetime)
{
    ASSERT_ERR((((uint16_t)rxctetime << 0) & ~((uint16_t)0x0000001F)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXCTEPTR_ADDR   (EM_BASE_ADDR + 0x18 + EM_BLE_RX_DESC_OFFSET)
#else
#define EM_BLE_RXCTEPTR_ADDR   (0x50004018 + EM_BLE_RX_DESC_OFFSET)
#endif

#define EM_BLE_RXCTEPTR_INDEX  0x0000000C
#define EM_BLE_RXCTEPTR_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxcteptr_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXCTEPTR_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
}

__INLINE__ void em_ble_rxcteptr_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_rxcteptr_getf(int elt_idx)
{
...
__INLINE__ void em_ble_rxcteptr_setf(int elt_idx, uint16_t rxcteptr)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXRESERVED_ADDR   (EM_BASE_ADDR + 0x1A + EM_BLE_RX_DESC_OFFSET)
#else
#define EM_BLE_RXRESERVED_ADDR   (0x5000401A + EM_BLE_RX_DESC_OFFSET)
#endif

#define EM_BLE_RXRESERVED_INDEX  0x0000000D
#define EM_BLE_RXRESERVED_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxreserved_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXRESERVED_ADDR + elt_idx * REG_EM_BLE_RX_DESC_SIZE);
}

__INLINE__ void em_ble_rxreserved_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_rxreserved_rsvd_getf(int elt_idx)
{
...
__INLINE__ void em_ble_rxreserved_rsvd_setf(int elt_idx, uint16_t rsvd)
{
