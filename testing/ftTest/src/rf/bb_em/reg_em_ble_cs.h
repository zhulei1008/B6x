 ...
 * </pre>
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_CNTL_ADDR   (EM_BASE_ADDR + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_CNTL_ADDR   (0x50004000 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_CNTL_INDEX  0x00000000
#define EM_BLE_CNTL_RESET  0x00000000

__INLINE__ uint16_t em_ble_cntl_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_CNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_cntl_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_cntl_pack(int elt_idx, uint8_t txbsyen, uint8_t rxbsyen, uint8_t dnabort, uint8_t format)
{
...
__INLINE__ void em_ble_cntl_unpack(int elt_idx, uint8_t* txbsyen, uint8_t* rxbsyen, uint8_t* dnabort, uint8_t* format)
{
...
__INLINE__ uint8_t em_ble_cntl_txbsy_en_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_CNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000400)) >> 10);
}

__INLINE__ void em_ble_cntl_txbsy_en_setf(int elt_idx, uint8_t txbsyen)
{
    ASSERT_ERR((((uint16_t)txbsyen << 10) & ~((uint16_t)0x00000400)) == 0);
...
__INLINE__ uint8_t em_ble_cntl_rxbsy_en_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_CNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000200)) >> 9);
}

__INLINE__ void em_ble_cntl_rxbsy_en_setf(int elt_idx, uint8_t rxbsyen)
{
    ASSERT_ERR((((uint16_t)rxbsyen << 9) & ~((uint16_t)0x00000200)) == 0);
...
__INLINE__ uint8_t em_ble_cntl_dnabort_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_CNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000100)) >> 8);
}

__INLINE__ void em_ble_cntl_dnabort_setf(int elt_idx, uint8_t dnabort)
{
    ASSERT_ERR((((uint16_t)dnabort << 8) & ~((uint16_t)0x00000100)) == 0);
...
__INLINE__ uint8_t em_ble_cntl_format_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_CNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000001F)) >> 0);
}

__INLINE__ void em_ble_cntl_format_setf(int elt_idx, uint8_t format)
{
    ASSERT_ERR((((uint16_t)format << 0) & ~((uint16_t)0x0000001F)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_LINKCNTL_ADDR   (EM_BASE_ADDR + 0x02 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_LINKCNTL_ADDR   (0x50004002 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_LINKCNTL_INDEX  0x00000001
#define EM_BLE_LINKCNTL_RESET  0x00000000

__INLINE__ uint16_t em_ble_linkcntl_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_LINKCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_linkcntl_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_linkcntl_pack(int elt_idx, uint8_t linklbl, uint8_t sas, uint8_t nullrxllidflt, uint8_t micmode, uint8_t cryptmode, uint8_t txcrypten, uint8_t rxcrypten, uint8_t privnpub)
{
...
__INLINE__ void em_ble_linkcntl_unpack(int elt_idx, uint8_t* linklbl, uint8_t* sas, uint8_t* nullrxllidflt, uint8_t* micmode, uint8_t* cryptmode, uint8_t* txcrypten, uint8_t* rxcrypten, uint8_t* privnpub)
{
...
__INLINE__ uint8_t em_ble_linkcntl_linklbl_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_LINKCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00001F00)) >> 8);
}

__INLINE__ void em_ble_linkcntl_linklbl_setf(int elt_idx, uint8_t linklbl)
{
    ASSERT_ERR((((uint16_t)linklbl << 8) & ~((uint16_t)0x00001F00)) == 0);
...
__INLINE__ uint8_t em_ble_linkcntl_sas_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_LINKCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000040)) >> 6);
}

__INLINE__ void em_ble_linkcntl_sas_setf(int elt_idx, uint8_t sas)
{
    ASSERT_ERR((((uint16_t)sas << 6) & ~((uint16_t)0x00000040)) == 0);
...
__INLINE__ uint8_t em_ble_linkcntl_nullrxllidflt_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_LINKCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000020)) >> 5);
}

__INLINE__ void em_ble_linkcntl_nullrxllidflt_setf(int elt_idx, uint8_t nullrxllidflt)
{
    ASSERT_ERR((((uint16_t)nullrxllidflt << 5) & ~((uint16_t)0x00000020)) == 0);
...
__INLINE__ uint8_t em_ble_linkcntl_mic_mode_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_LINKCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000010)) >> 4);
}

__INLINE__ void em_ble_linkcntl_mic_mode_setf(int elt_idx, uint8_t micmode)
{
    ASSERT_ERR((((uint16_t)micmode << 4) & ~((uint16_t)0x00000010)) == 0);
...
__INLINE__ uint8_t em_ble_linkcntl_crypt_mode_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_LINKCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000008)) >> 3);
}

__INLINE__ void em_ble_linkcntl_crypt_mode_setf(int elt_idx, uint8_t cryptmode)
{
    ASSERT_ERR((((uint16_t)cryptmode << 3) & ~((uint16_t)0x00000008)) == 0);
...
__INLINE__ uint8_t em_ble_linkcntl_txcrypt_en_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_LINKCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000004)) >> 2);
}

__INLINE__ void em_ble_linkcntl_txcrypt_en_setf(int elt_idx, uint8_t txcrypten)
{
    ASSERT_ERR((((uint16_t)txcrypten << 2) & ~((uint16_t)0x00000004)) == 0);
...
__INLINE__ uint8_t em_ble_linkcntl_rxcrypt_en_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_LINKCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000002)) >> 1);
}

__INLINE__ void em_ble_linkcntl_rxcrypt_en_setf(int elt_idx, uint8_t rxcrypten)
{
    ASSERT_ERR((((uint16_t)rxcrypten << 1) & ~((uint16_t)0x00000002)) == 0);
...
__INLINE__ uint8_t em_ble_linkcntl_priv_npub_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_LINKCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000001)) >> 0);
}

__INLINE__ void em_ble_linkcntl_priv_npub_setf(int elt_idx, uint8_t privnpub)
{
    ASSERT_ERR((((uint16_t)privnpub << 0) & ~((uint16_t)0x00000001)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_ISOLINKCNTL_ADDR   (EM_BASE_ADDR + 0x04 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_ISOLINKCNTL_ADDR   (0x50004004 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_ISOLINKCNTL_INDEX  0x00000002
#define EM_BLE_ISOLINKCNTL_RESET  0x00000000

__INLINE__ uint16_t em_ble_isolinkcntl_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_ISOLINKCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_isolinkcntl_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_isolinkcntl_pack(int elt_idx, uint8_t streamlbl, uint8_t grouplbl, uint8_t isosyncmode, uint8_t isosyncen, uint8_t isotype)
{
...
__INLINE__ void em_ble_isolinkcntl_unpack(int elt_idx, uint8_t* streamlbl, uint8_t* grouplbl, uint8_t* isosyncmode, uint8_t* isosyncen, uint8_t* isotype)
{
...
__INLINE__ uint8_t em_ble_isolinkcntl_stream_lbl_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_ISOLINKCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000F800)) >> 11);
}

__INLINE__ void em_ble_isolinkcntl_stream_lbl_setf(int elt_idx, uint8_t streamlbl)
{
    ASSERT_ERR((((uint16_t)streamlbl << 11) & ~((uint16_t)0x0000F800)) == 0);
...
__INLINE__ uint8_t em_ble_isolinkcntl_group_lbl_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_ISOLINKCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000700)) >> 8);
}

__INLINE__ void em_ble_isolinkcntl_group_lbl_setf(int elt_idx, uint8_t grouplbl)
{
    ASSERT_ERR((((uint16_t)grouplbl << 8) & ~((uint16_t)0x00000700)) == 0);
...
__INLINE__ uint8_t em_ble_isolinkcntl_isosyncmode_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_ISOLINKCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000008)) >> 3);
}

__INLINE__ void em_ble_isolinkcntl_isosyncmode_setf(int elt_idx, uint8_t isosyncmode)
{
    ASSERT_ERR((((uint16_t)isosyncmode << 3) & ~((uint16_t)0x00000008)) == 0);
...
__INLINE__ uint8_t em_ble_isolinkcntl_isosyncen_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_ISOLINKCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000004)) >> 2);
}

__INLINE__ void em_ble_isolinkcntl_isosyncen_setf(int elt_idx, uint8_t isosyncen)
{
    ASSERT_ERR((((uint16_t)isosyncen << 2) & ~((uint16_t)0x00000004)) == 0);
...
__INLINE__ uint8_t em_ble_isolinkcntl_isotype_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_ISOLINKCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000003)) >> 0);
}

__INLINE__ void em_ble_isolinkcntl_isotype_setf(int elt_idx, uint8_t isotype)
{
    ASSERT_ERR((((uint16_t)isotype << 0) & ~((uint16_t)0x00000003)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_THRCNTL_RATECNTL_ADDR   (EM_BASE_ADDR + 0x06 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_THRCNTL_RATECNTL_ADDR   (0x50004006 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_THRCNTL_RATECNTL_INDEX  0x00000003
#define EM_BLE_THRCNTL_RATECNTL_RESET  0x00000000

__INLINE__ uint16_t em_ble_thrcntl_ratecntl_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_THRCNTL_RATECNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_thrcntl_ratecntl_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_thrcntl_ratecntl_pack(int elt_idx, uint8_t rxthr, uint8_t txthr, uint8_t auxrate, uint8_t rxrate, uint8_t txrate)
{
...
__INLINE__ void em_ble_thrcntl_ratecntl_unpack(int elt_idx, uint8_t* rxthr, uint8_t* txthr, uint8_t* auxrate, uint8_t* rxrate, uint8_t* txrate)
{
...
__INLINE__ uint8_t em_ble_thrcntl_ratecntl_rxthr_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_THRCNTL_RATECNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000F000)) >> 12);
}

__INLINE__ void em_ble_thrcntl_ratecntl_rxthr_setf(int elt_idx, uint8_t rxthr)
{
    ASSERT_ERR((((uint16_t)rxthr << 12) & ~((uint16_t)0x0000F000)) == 0);
...
__INLINE__ uint8_t em_ble_thrcntl_ratecntl_txthr_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_THRCNTL_RATECNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000F00)) >> 8);
}

__INLINE__ void em_ble_thrcntl_ratecntl_txthr_setf(int elt_idx, uint8_t txthr)
{
    ASSERT_ERR((((uint16_t)txthr << 8) & ~((uint16_t)0x00000F00)) == 0);
...
__INLINE__ uint8_t em_ble_thrcntl_ratecntl_aux_rate_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_THRCNTL_RATECNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000030)) >> 4);
}

__INLINE__ void em_ble_thrcntl_ratecntl_aux_rate_setf(int elt_idx, uint8_t auxrate)
{
    ASSERT_ERR((((uint16_t)auxrate << 4) & ~((uint16_t)0x00000030)) == 0);
...
__INLINE__ uint8_t em_ble_thrcntl_ratecntl_rxrate_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_THRCNTL_RATECNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000000C)) >> 2);
}

__INLINE__ void em_ble_thrcntl_ratecntl_rxrate_setf(int elt_idx, uint8_t rxrate)
{
    ASSERT_ERR((((uint16_t)rxrate << 2) & ~((uint16_t)0x0000000C)) == 0);
...
__INLINE__ uint8_t em_ble_thrcntl_ratecntl_txrate_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_THRCNTL_RATECNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000003)) >> 0);
}

__INLINE__ void em_ble_thrcntl_ratecntl_txrate_setf(int elt_idx, uint8_t txrate)
{
    ASSERT_ERR((((uint16_t)txrate << 0) & ~((uint16_t)0x00000003)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_LEBDADDR_ADDR   (EM_BASE_ADDR + 0x08 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_LEBDADDR_ADDR   (0x50004008 + EM_BLE_CS_OFFSET)
#endif
...
__INLINE__ uint16_t em_ble_lebdaddr_get(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 2);
    return EM_BLE_RD(EM_BLE_LEBDADDR_ADDR + elt_idx * REG_EM_BLE_CS_SIZE + reg_idx * 2);
}

__INLINE__ void em_ble_lebdaddr_set(int elt_idx, int reg_idx, uint16_t value)
{
    ASSERT_ERR(reg_idx <= 2);
...
__INLINE__ uint16_t em_ble_lebdaddr_bdaddr_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 2);
...
__INLINE__ void em_ble_lebdaddr_bdaddr_setf(int elt_idx, int reg_idx, uint16_t bdaddr)
{
    ASSERT_ERR(reg_idx <= 2);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_SYNCWL_ADDR   (EM_BASE_ADDR + 0x0E + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_SYNCWL_ADDR   (0x5000400E + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_SYNCWL_INDEX  0x00000007
#define EM_BLE_SYNCWL_RESET  0x00000000

__INLINE__ uint16_t em_ble_syncwl_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_SYNCWL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_syncwl_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_syncwl_syncwordl_getf(int elt_idx)
{
...
__INLINE__ void em_ble_syncwl_syncwordl_setf(int elt_idx, uint16_t syncwordl)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_SYNCWH_ADDR   (EM_BASE_ADDR + 0x10 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_SYNCWH_ADDR   (0x50004010 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_SYNCWH_INDEX  0x00000008
#define EM_BLE_SYNCWH_RESET  0x00000000

__INLINE__ uint16_t em_ble_syncwh_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_SYNCWH_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_syncwh_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_syncwh_syncwordh_getf(int elt_idx)
{
...
__INLINE__ void em_ble_syncwh_syncwordh_setf(int elt_idx, uint16_t syncwordh)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_CRCINIT0_ADDR   (EM_BASE_ADDR + 0x12 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_CRCINIT0_ADDR   (0x50004012 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_CRCINIT0_INDEX  0x00000009
#define EM_BLE_CRCINIT0_RESET  0x00000000

__INLINE__ uint16_t em_ble_crcinit0_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_CRCINIT0_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_crcinit0_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_crcinit0_getf(int elt_idx)
{
...
__INLINE__ void em_ble_crcinit0_setf(int elt_idx, uint16_t crcinit0)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_CRCINIT1_ADDR   (EM_BASE_ADDR + 0x14 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_CRCINIT1_ADDR   (0x50004014 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_CRCINIT1_INDEX  0x0000000A
#define EM_BLE_CRCINIT1_RESET  0x00000000

__INLINE__ uint16_t em_ble_crcinit1_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_CRCINIT1_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_crcinit1_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_crcinit1_pack(int elt_idx, uint8_t rxmaxctebuf, uint8_t crcinit1)
{
...
__INLINE__ void em_ble_crcinit1_unpack(int elt_idx, uint8_t* rxmaxctebuf, uint8_t* crcinit1)
{
...
__INLINE__ uint8_t em_ble_crcinit1_rxmaxctebuf_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_CRCINIT1_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000FF00)) >> 8);
}

__INLINE__ void em_ble_crcinit1_rxmaxctebuf_setf(int elt_idx, uint8_t rxmaxctebuf)
{
    ASSERT_ERR((((uint16_t)rxmaxctebuf << 8) & ~((uint16_t)0x0000FF00)) == 0);
...
__INLINE__ uint8_t em_ble_crcinit1_crcinit1_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_CRCINIT1_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x000000FF)) >> 0);
}

__INLINE__ void em_ble_crcinit1_crcinit1_setf(int elt_idx, uint8_t crcinit1)
{
    ASSERT_ERR((((uint16_t)crcinit1 << 0) & ~((uint16_t)0x000000FF)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_FILTPOL_RALCNTL_ADDR   (EM_BASE_ADDR + 0x16 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_FILTPOL_RALCNTL_ADDR   (0x50004016 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_FILTPOL_RALCNTL_INDEX  0x0000000B
#define EM_BLE_FILTPOL_RALCNTL_RESET  0x00000000

__INLINE__ uint16_t em_ble_filtpol_ralcntl_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_FILTPOL_RALCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_filtpol_ralcntl_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_filtpol_ralcntl_pack(int elt_idx, uint8_t filterpolicy, uint8_t ralresolen, uint8_t peradvfilten, uint8_t localrpasel, uint8_t ralmode, uint8_t ralen)
{
...
__INLINE__ void em_ble_filtpol_ralcntl_unpack(int elt_idx, uint8_t* filterpolicy, uint8_t* ralresolen, uint8_t* peradvfilten, uint8_t* localrpasel, uint8_t* ralmode, uint8_t* ralen)
{
...
__INLINE__ uint8_t em_ble_filtpol_ralcntl_filter_policy_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_FILTPOL_RALCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000FF00)) >> 8);
}

__INLINE__ void em_ble_filtpol_ralcntl_filter_policy_setf(int elt_idx, uint8_t filterpolicy)
{
    ASSERT_ERR((((uint16_t)filterpolicy << 8) & ~((uint16_t)0x0000FF00)) == 0);
...
__INLINE__ uint8_t em_ble_filtpol_ralcntl_ral_resol_en_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_FILTPOL_RALCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000010)) >> 4);
}

__INLINE__ void em_ble_filtpol_ralcntl_ral_resol_en_setf(int elt_idx, uint8_t ralresolen)
{
    ASSERT_ERR((((uint16_t)ralresolen << 4) & ~((uint16_t)0x00000010)) == 0);
...
__INLINE__ uint8_t em_ble_filtpol_ralcntl_peradv_filt_en_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_FILTPOL_RALCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000008)) >> 3);
}

__INLINE__ void em_ble_filtpol_ralcntl_peradv_filt_en_setf(int elt_idx, uint8_t peradvfilten)
{
    ASSERT_ERR((((uint16_t)peradvfilten << 3) & ~((uint16_t)0x00000008)) == 0);
...
__INLINE__ uint8_t em_ble_filtpol_ralcntl_local_rpa_sel_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_FILTPOL_RALCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000004)) >> 2);
}

__INLINE__ void em_ble_filtpol_ralcntl_local_rpa_sel_setf(int elt_idx, uint8_t localrpasel)
{
    ASSERT_ERR((((uint16_t)localrpasel << 2) & ~((uint16_t)0x00000004)) == 0);
...
__INLINE__ uint8_t em_ble_filtpol_ralcntl_ral_mode_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_FILTPOL_RALCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000002)) >> 1);
}

__INLINE__ void em_ble_filtpol_ralcntl_ral_mode_setf(int elt_idx, uint8_t ralmode)
{
    ASSERT_ERR((((uint16_t)ralmode << 1) & ~((uint16_t)0x00000002)) == 0);
...
__INLINE__ uint8_t em_ble_filtpol_ralcntl_ral_en_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_FILTPOL_RALCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000001)) >> 0);
}

__INLINE__ void em_ble_filtpol_ralcntl_ral_en_setf(int elt_idx, uint8_t ralen)
{
    ASSERT_ERR((((uint16_t)ralen << 0) & ~((uint16_t)0x00000001)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_HOPCNTL_ADDR   (EM_BASE_ADDR + 0x18 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_HOPCNTL_ADDR   (0x50004018 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_HOPCNTL_INDEX  0x0000000C
#define EM_BLE_HOPCNTL_RESET  0x00000000

__INLINE__ uint16_t em_ble_hopcntl_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_HOPCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_hopcntl_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_hopcntl_pack(int elt_idx, uint8_t fhen, uint8_t hopmode, uint8_t hopint, uint8_t chidx)
{
...
__INLINE__ void em_ble_hopcntl_unpack(int elt_idx, uint8_t* fhen, uint8_t* hopmode, uint8_t* hopint, uint8_t* chidx)
{
...
__INLINE__ uint8_t em_ble_hopcntl_fh_en_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_HOPCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__INLINE__ void em_ble_hopcntl_fh_en_setf(int elt_idx, uint8_t fhen)
{
    ASSERT_ERR((((uint16_t)fhen << 15) & ~((uint16_t)0x00008000)) == 0);
...
__INLINE__ uint8_t em_ble_hopcntl_hop_mode_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_HOPCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00006000)) >> 13);
}

__INLINE__ void em_ble_hopcntl_hop_mode_setf(int elt_idx, uint8_t hopmode)
{
    ASSERT_ERR((((uint16_t)hopmode << 13) & ~((uint16_t)0x00006000)) == 0);
...
__INLINE__ uint8_t em_ble_hopcntl_hop_int_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_HOPCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00001F00)) >> 8);
}

__INLINE__ void em_ble_hopcntl_hop_int_setf(int elt_idx, uint8_t hopint)
{
    ASSERT_ERR((((uint16_t)hopint << 8) & ~((uint16_t)0x00001F00)) == 0);
...
__INLINE__ uint8_t em_ble_hopcntl_ch_idx_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_HOPCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000003F)) >> 0);
}

__INLINE__ void em_ble_hopcntl_ch_idx_setf(int elt_idx, uint8_t chidx)
{
    ASSERT_ERR((((uint16_t)chidx << 0) & ~((uint16_t)0x0000003F)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_TXRXCNTL_ADDR   (EM_BASE_ADDR + 0x1A + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_TXRXCNTL_ADDR   (0x5000401A + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_TXRXCNTL_INDEX  0x0000000D
#define EM_BLE_TXRXCNTL_RESET  0x00000000

__INLINE__ uint16_t em_ble_txrxcntl_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXRXCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_txrxcntl_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_txrxcntl_pack(int elt_idx, uint8_t rxbufffull, uint8_t lastempty, uint8_t sn, uint8_t nesn, uint8_t rxbfmicerr, uint8_t rxmafserr, uint8_t endsonsac, uint8_t extpaen, uint8_t txpwr)
{
...
__INLINE__ void em_ble_txrxcntl_unpack(int elt_idx, uint8_t* rxbufffull, uint8_t* lastempty, uint8_t* sn, uint8_t* nesn, uint8_t* rxbfmicerr, uint8_t* rxmafserr, uint8_t* endsonsac, uint8_t* extpaen, uint8_t* txpwr)
{
...
__INLINE__ uint8_t em_ble_txrxcntl_rxbuff_full_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXRXCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__INLINE__ void em_ble_txrxcntl_rxbuff_full_setf(int elt_idx, uint8_t rxbufffull)
{
    ASSERT_ERR((((uint16_t)rxbufffull << 15) & ~((uint16_t)0x00008000)) == 0);
...
__INLINE__ uint8_t em_ble_txrxcntl_lastempty_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXRXCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00004000)) >> 14);
}

__INLINE__ void em_ble_txrxcntl_lastempty_setf(int elt_idx, uint8_t lastempty)
{
    ASSERT_ERR((((uint16_t)lastempty << 14) & ~((uint16_t)0x00004000)) == 0);
...
__INLINE__ uint8_t em_ble_txrxcntl_sn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXRXCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00002000)) >> 13);
}

__INLINE__ void em_ble_txrxcntl_sn_setf(int elt_idx, uint8_t sn)
{
    ASSERT_ERR((((uint16_t)sn << 13) & ~((uint16_t)0x00002000)) == 0);
...
__INLINE__ uint8_t em_ble_txrxcntl_nesn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXRXCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00001000)) >> 12);
}

__INLINE__ void em_ble_txrxcntl_nesn_setf(int elt_idx, uint8_t nesn)
{
    ASSERT_ERR((((uint16_t)nesn << 12) & ~((uint16_t)0x00001000)) == 0);
...
__INLINE__ uint8_t em_ble_txrxcntl_rxbfmicerr_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXRXCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000800)) >> 11);
}

__INLINE__ void em_ble_txrxcntl_rxbfmicerr_setf(int elt_idx, uint8_t rxbfmicerr)
{
    ASSERT_ERR((((uint16_t)rxbfmicerr << 11) & ~((uint16_t)0x00000800)) == 0);
...
__INLINE__ uint8_t em_ble_txrxcntl_rxmafserr_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXRXCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000400)) >> 10);
}

__INLINE__ void em_ble_txrxcntl_rxmafserr_setf(int elt_idx, uint8_t rxmafserr)
{
    ASSERT_ERR((((uint16_t)rxmafserr << 10) & ~((uint16_t)0x00000400)) == 0);
...
__INLINE__ uint8_t em_ble_txrxcntl_ends_on_sac_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXRXCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000200)) >> 9);
}

__INLINE__ void em_ble_txrxcntl_ends_on_sac_setf(int elt_idx, uint8_t endsonsac)
{
    ASSERT_ERR((((uint16_t)endsonsac << 9) & ~((uint16_t)0x00000200)) == 0);
...
__INLINE__ uint8_t em_ble_txrxcntl_ext_pa_en_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXRXCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000100)) >> 8);
}

__INLINE__ void em_ble_txrxcntl_ext_pa_en_setf(int elt_idx, uint8_t extpaen)
{
    ASSERT_ERR((((uint16_t)extpaen << 8) & ~((uint16_t)0x00000100)) == 0);
...
__INLINE__ uint8_t em_ble_txrxcntl_txpwr_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXRXCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x000000FF)) >> 0);
}

__INLINE__ void em_ble_txrxcntl_txpwr_setf(int elt_idx, uint8_t txpwr)
{
    ASSERT_ERR((((uint16_t)txpwr << 0) & ~((uint16_t)0x000000FF)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXDFCNTL_ADDR   (EM_BASE_ADDR + 0x1C + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_RXDFCNTL_ADDR   (0x5000401C + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_RXDFCNTL_INDEX  0x0000000E
#define EM_BLE_RXDFCNTL_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxdfcntl_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXDFCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_rxdfcntl_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_rxdfcntl_pack(int elt_idx, uint8_t dfrspen, uint8_t dfswcntl, uint8_t dfsampcntl, uint8_t dftype, uint8_t dffilteren, uint8_t dfen)
{
...
__INLINE__ void em_ble_rxdfcntl_unpack(int elt_idx, uint8_t* dfrspen, uint8_t* dfswcntl, uint8_t* dfsampcntl, uint8_t* dftype, uint8_t* dffilteren, uint8_t* dfen)
{
...
__INLINE__ uint8_t em_ble_rxdfcntl_dfrspen_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXDFCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000100)) >> 8);
}

__INLINE__ void em_ble_rxdfcntl_dfrspen_setf(int elt_idx, uint8_t dfrspen)
{
    ASSERT_ERR((((uint16_t)dfrspen << 8) & ~((uint16_t)0x00000100)) == 0);
...
__INLINE__ uint8_t em_ble_rxdfcntl_dfswcntl_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXDFCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x000000C0)) >> 6);
}

__INLINE__ void em_ble_rxdfcntl_dfswcntl_setf(int elt_idx, uint8_t dfswcntl)
{
    ASSERT_ERR((((uint16_t)dfswcntl << 6) & ~((uint16_t)0x000000C0)) == 0);
...
__INLINE__ uint8_t em_ble_rxdfcntl_dfsampcntl_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXDFCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000030)) >> 4);
}

__INLINE__ void em_ble_rxdfcntl_dfsampcntl_setf(int elt_idx, uint8_t dfsampcntl)
{
    ASSERT_ERR((((uint16_t)dfsampcntl << 4) & ~((uint16_t)0x00000030)) == 0);
...
__INLINE__ uint8_t em_ble_rxdfcntl_dftype_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXDFCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000000C)) >> 2);
}

__INLINE__ void em_ble_rxdfcntl_dftype_setf(int elt_idx, uint8_t dftype)
{
    ASSERT_ERR((((uint16_t)dftype << 2) & ~((uint16_t)0x0000000C)) == 0);
...
__INLINE__ uint8_t em_ble_rxdfcntl_dffilteren_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXDFCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000002)) >> 1);
}

__INLINE__ void em_ble_rxdfcntl_dffilteren_setf(int elt_idx, uint8_t dffilteren)
{
    ASSERT_ERR((((uint16_t)dffilteren << 1) & ~((uint16_t)0x00000002)) == 0);
...
__INLINE__ uint8_t em_ble_rxdfcntl_dfen_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXDFCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000001)) >> 0);
}

__INLINE__ void em_ble_rxdfcntl_dfen_setf(int elt_idx, uint8_t dfen)
{
    ASSERT_ERR((((uint16_t)dfen << 0) & ~((uint16_t)0x00000001)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXWINCNTL_ADDR   (EM_BASE_ADDR + 0x1E + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_RXWINCNTL_ADDR   (0x5000401E + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_RXWINCNTL_INDEX  0x0000000F
#define EM_BLE_RXWINCNTL_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxwincntl_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXWINCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_rxwincntl_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_rxwincntl_pack(int elt_idx, uint8_t rxwide, uint16_t rxwinsz)
{
...
__INLINE__ void em_ble_rxwincntl_unpack(int elt_idx, uint8_t* rxwide, uint16_t* rxwinsz)
{
...
__INLINE__ uint8_t em_ble_rxwincntl_rxwide_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXWINCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__INLINE__ void em_ble_rxwincntl_rxwide_setf(int elt_idx, uint8_t rxwide)
{
    ASSERT_ERR((((uint16_t)rxwide << 15) & ~((uint16_t)0x00008000)) == 0);
...
__INLINE__ uint16_t em_ble_rxwincntl_rxwinsz_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXWINCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00007FFF)) >> 0);
}

__INLINE__ void em_ble_rxwincntl_rxwinsz_setf(int elt_idx, uint16_t rxwinsz)
{
    ASSERT_ERR((((uint16_t)rxwinsz << 0) & ~((uint16_t)0x00007FFF)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_ISOTXDESCPTR_ADDR   (EM_BASE_ADDR + 0x20 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_ISOTXDESCPTR_ADDR   (0x50004020 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_ISOTXDESCPTR_INDEX  0x00000010
#define EM_BLE_ISOTXDESCPTR_RESET  0x00000000

__INLINE__ uint16_t em_ble_isotxdescptr_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_ISOTXDESCPTR_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_isotxdescptr_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_isotxdescptr_getf(int elt_idx)
{
...
__INLINE__ void em_ble_isotxdescptr_setf(int elt_idx, uint16_t isotxdescptr)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_ISORXDESCPTR_ADDR   (EM_BASE_ADDR + 0x22 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_ISORXDESCPTR_ADDR   (0x50004022 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_ISORXDESCPTR_INDEX  0x00000011
#define EM_BLE_ISORXDESCPTR_RESET  0x00000000

__INLINE__ uint16_t em_ble_isorxdescptr_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_ISORXDESCPTR_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_isorxdescptr_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_isorxdescptr_getf(int elt_idx)
{
...
__INLINE__ void em_ble_isorxdescptr_setf(int elt_idx, uint16_t isorxdescptr)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_ACLTXDESCPTR_ADDR   (EM_BASE_ADDR + 0x24 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_ACLTXDESCPTR_ADDR   (0x50004024 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_ACLTXDESCPTR_INDEX  0x00000012
#define EM_BLE_ACLTXDESCPTR_RESET  0x00000000

__INLINE__ uint16_t em_ble_acltxdescptr_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_ACLTXDESCPTR_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_acltxdescptr_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_acltxdescptr_getf(int elt_idx)
{
...
__INLINE__ void em_ble_acltxdescptr_setf(int elt_idx, uint16_t acltxdescptr)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXDFANTPATTCNTL_ADDR   (EM_BASE_ADDR + 0x26 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_RXDFANTPATTCNTL_ADDR   (0x50004026 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_RXDFANTPATTCNTL_INDEX  0x00000013
#define EM_BLE_RXDFANTPATTCNTL_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxdfantpattcntl_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXDFANTPATTCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_rxdfantpattcntl_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_rxdfantpattcntl_pack(int elt_idx, uint8_t dfrsp, uint8_t maxsampcte, uint8_t rxantpattlength)
{
...
__INLINE__ void em_ble_rxdfantpattcntl_unpack(int elt_idx, uint8_t* dfrsp, uint8_t* maxsampcte, uint8_t* rxantpattlength)
{
...
__INLINE__ uint8_t em_ble_rxdfantpattcntl_dfrsp_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXDFANTPATTCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__INLINE__ void em_ble_rxdfantpattcntl_dfrsp_setf(int elt_idx, uint8_t dfrsp)
{
    ASSERT_ERR((((uint16_t)dfrsp << 15) & ~((uint16_t)0x00008000)) == 0);
...
__INLINE__ uint8_t em_ble_rxdfantpattcntl_max_samp_cte_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXDFANTPATTCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00001F00)) >> 8);
}

__INLINE__ void em_ble_rxdfantpattcntl_max_samp_cte_setf(int elt_idx, uint8_t maxsampcte)
{
    ASSERT_ERR((((uint16_t)maxsampcte << 8) & ~((uint16_t)0x00001F00)) == 0);
...
__INLINE__ uint8_t em_ble_rxdfantpattcntl_rx_ant_patt_length_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXDFANTPATTCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000007F)) >> 0);
}

__INLINE__ void em_ble_rxdfantpattcntl_rx_ant_patt_length_setf(int elt_idx, uint8_t rxantpattlength)
{
    ASSERT_ERR((((uint16_t)rxantpattlength << 0) & ~((uint16_t)0x0000007F)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXDFANTSWPTR_ADDR   (EM_BASE_ADDR + 0x28 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_RXDFANTSWPTR_ADDR   (0x50004028 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_RXDFANTSWPTR_INDEX  0x00000014
#define EM_BLE_RXDFANTSWPTR_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxdfantswptr_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXDFANTSWPTR_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_rxdfantswptr_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_rxdfantswptr_rx_antenna_id_ptr_getf(int elt_idx)
{
...
__INLINE__ void em_ble_rxdfantswptr_rx_antenna_id_ptr_setf(int elt_idx, uint16_t rxantennaidptr)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_TXDFANTPATTCNTL_ADDR   (EM_BASE_ADDR + 0x2A + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_TXDFANTPATTCNTL_ADDR   (0x5000402A + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_TXDFANTPATTCNTL_INDEX  0x00000015
#define EM_BLE_TXDFANTPATTCNTL_RESET  0x00000000

__INLINE__ uint16_t em_ble_txdfantpattcntl_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXDFANTPATTCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_txdfantpattcntl_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint8_t em_ble_txdfantpattcntl_tx_ant_patt_length_getf(int elt_idx)
{
...
__INLINE__ void em_ble_txdfantpattcntl_tx_ant_patt_length_setf(int elt_idx, uint8_t txantpattlength)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_TXDFANTSWPTR_ADDR   (EM_BASE_ADDR + 0x2C + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_TXDFANTSWPTR_ADDR   (0x5000402C + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_TXDFANTSWPTR_INDEX  0x00000016
#define EM_BLE_TXDFANTSWPTR_RESET  0x00000000

__INLINE__ uint16_t em_ble_txdfantswptr_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXDFANTSWPTR_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_txdfantswptr_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_txdfantswptr_tx_antenna_id_ptr_getf(int elt_idx)
{
...
__INLINE__ void em_ble_txdfantswptr_tx_antenna_id_ptr_setf(int elt_idx, uint16_t txantennaidptr)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_WINOFFSET_ADDR   (EM_BASE_ADDR + 0x2E + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_WINOFFSET_ADDR   (0x5000402E + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_WINOFFSET_INDEX  0x00000017
#define EM_BLE_WINOFFSET_RESET  0x00000000

__INLINE__ uint16_t em_ble_winoffset_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_WINOFFSET_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_winoffset_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_winoffset_getf(int elt_idx)
{
...
__INLINE__ void em_ble_winoffset_setf(int elt_idx, uint16_t winoffset)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_MINEVTIME_ADDR   (EM_BASE_ADDR + 0x2E + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_MINEVTIME_ADDR   (0x5000402E + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_MINEVTIME_INDEX  0x00000017
#define EM_BLE_MINEVTIME_RESET  0x00000000

__INLINE__ uint16_t em_ble_minevtime_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_MINEVTIME_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_minevtime_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_minevtime_getf(int elt_idx)
{
...
__INLINE__ void em_ble_minevtime_setf(int elt_idx, uint16_t minevtime)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_MAXEVTIME_ADDR   (EM_BASE_ADDR + 0x30 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_MAXEVTIME_ADDR   (0x50004030 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_MAXEVTIME_INDEX  0x00000018
#define EM_BLE_MAXEVTIME_RESET  0x00000000

__INLINE__ uint16_t em_ble_maxevtime_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_MAXEVTIME_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_maxevtime_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_maxevtime_getf(int elt_idx)
{
...
__INLINE__ void em_ble_maxevtime_setf(int elt_idx, uint16_t maxevtime)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_CONNINTERVAL_ADDR   (EM_BASE_ADDR + 0x32 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_CONNINTERVAL_ADDR   (0x50004032 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_CONNINTERVAL_INDEX  0x00000019
#define EM_BLE_CONNINTERVAL_RESET  0x00000000

__INLINE__ uint16_t em_ble_conninterval_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_CONNINTERVAL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_conninterval_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_conninterval_getf(int elt_idx)
{
...
__INLINE__ void em_ble_conninterval_setf(int elt_idx, uint16_t conninterval)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_CHMAP0_ADDR   (EM_BASE_ADDR + 0x32 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_CHMAP0_ADDR   (0x50004032 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_CHMAP0_INDEX  0x00000019
#define EM_BLE_CHMAP0_RESET  0x0000FFFF

__INLINE__ uint16_t em_ble_chmap0_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_CHMAP0_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_chmap0_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_chmap0_llchmap0_getf(int elt_idx)
{
...
__INLINE__ void em_ble_chmap0_llchmap0_setf(int elt_idx, uint16_t llchmap0)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_CHMAP1_ADDR   (EM_BASE_ADDR + 0x34 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_CHMAP1_ADDR   (0x50004034 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_CHMAP1_INDEX  0x0000001A
#define EM_BLE_CHMAP1_RESET  0x0000FFFF

__INLINE__ uint16_t em_ble_chmap1_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_CHMAP1_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_chmap1_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_chmap1_llchmap1_getf(int elt_idx)
{
...
__INLINE__ void em_ble_chmap1_llchmap1_setf(int elt_idx, uint16_t llchmap1)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_CHMAP2_ADDR   (EM_BASE_ADDR + 0x36 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_CHMAP2_ADDR   (0x50004036 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_CHMAP2_INDEX  0x0000001B
#define EM_BLE_CHMAP2_RESET  0x000000FF

__INLINE__ uint16_t em_ble_chmap2_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_CHMAP2_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_chmap2_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_chmap2_pack(int elt_idx, uint8_t chaux, uint8_t advchmap, uint8_t llchmap2)
{
...
__INLINE__ void em_ble_chmap2_unpack(int elt_idx, uint8_t* chaux, uint8_t* advchmap, uint8_t* llchmap2)
{
...
__INLINE__ uint8_t em_ble_chmap2_ch_aux_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_CHMAP2_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000FC00)) >> 10);
}

__INLINE__ void em_ble_chmap2_ch_aux_setf(int elt_idx, uint8_t chaux)
{
    ASSERT_ERR((((uint16_t)chaux << 10) & ~((uint16_t)0x0000FC00)) == 0);
...
__INLINE__ uint8_t em_ble_chmap2_advchmap_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_CHMAP2_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x000000E0)) >> 5);
}

__INLINE__ void em_ble_chmap2_advchmap_setf(int elt_idx, uint8_t advchmap)
{
    ASSERT_ERR((((uint16_t)advchmap << 5) & ~((uint16_t)0x000000E0)) == 0);
...
__INLINE__ uint8_t em_ble_chmap2_llchmap2_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_CHMAP2_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000001F)) >> 0);
}

__INLINE__ void em_ble_chmap2_llchmap2_setf(int elt_idx, uint8_t llchmap2)
{
    ASSERT_ERR((((uint16_t)llchmap2 << 0) & ~((uint16_t)0x0000001F)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXMAXAUXCHAIN_ADDR   (EM_BASE_ADDR + 0x38 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_RXMAXAUXCHAIN_ADDR   (0x50004038 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_RXMAXAUXCHAIN_INDEX  0x0000001C
#define EM_BLE_RXMAXAUXCHAIN_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxmaxauxchain_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXMAXAUXCHAIN_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_rxmaxauxchain_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_rxmaxauxchain_pack(int elt_idx, uint8_t maxrxchdesc, uint16_t maxrxchbyte)
{
...
__INLINE__ void em_ble_rxmaxauxchain_unpack(int elt_idx, uint8_t* maxrxchdesc, uint16_t* maxrxchbyte)
{
...
__INLINE__ uint8_t em_ble_rxmaxauxchain_maxrxchdesc_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXMAXAUXCHAIN_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000F800)) >> 11);
}

__INLINE__ void em_ble_rxmaxauxchain_maxrxchdesc_setf(int elt_idx, uint8_t maxrxchdesc)
{
    ASSERT_ERR((((uint16_t)maxrxchdesc << 11) & ~((uint16_t)0x0000F800)) == 0);
...
__INLINE__ uint16_t em_ble_rxmaxauxchain_maxrxchbyte_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXMAXAUXCHAIN_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x000007FF)) >> 0);
}

__INLINE__ void em_ble_rxmaxauxchain_maxrxchbyte_setf(int elt_idx, uint16_t maxrxchbyte)
{
    ASSERT_ERR((((uint16_t)maxrxchbyte << 0) & ~((uint16_t)0x000007FF)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXMAXBUF_ADDR   (EM_BASE_ADDR + 0x38 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_RXMAXBUF_ADDR   (0x50004038 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_RXMAXBUF_INDEX  0x0000001C
#define EM_BLE_RXMAXBUF_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxmaxbuf_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXMAXBUF_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_rxmaxbuf_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_rxmaxbuf_pack(int elt_idx, uint8_t isorxmaxbuf, uint8_t aclrxmaxbuf)
{
...
__INLINE__ void em_ble_rxmaxbuf_unpack(int elt_idx, uint8_t* isorxmaxbuf, uint8_t* aclrxmaxbuf)
{
...
__INLINE__ uint8_t em_ble_rxmaxbuf_isorxmaxbuf_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXMAXBUF_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000FF00)) >> 8);
}

__INLINE__ void em_ble_rxmaxbuf_isorxmaxbuf_setf(int elt_idx, uint8_t isorxmaxbuf)
{
    ASSERT_ERR((((uint16_t)isorxmaxbuf << 8) & ~((uint16_t)0x0000FF00)) == 0);
...
__INLINE__ uint8_t em_ble_rxmaxbuf_aclrxmaxbuf_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXMAXBUF_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x000000FF)) >> 0);
}

__INLINE__ void em_ble_rxmaxbuf_aclrxmaxbuf_setf(int elt_idx, uint8_t aclrxmaxbuf)
{
    ASSERT_ERR((((uint16_t)aclrxmaxbuf << 0) & ~((uint16_t)0x000000FF)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXMAXTIME_ADDR   (EM_BASE_ADDR + 0x3A + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_RXMAXTIME_ADDR   (0x5000403A + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_RXMAXTIME_INDEX  0x0000001D
#define EM_BLE_RXMAXTIME_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxmaxtime_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXMAXTIME_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_rxmaxtime_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_rxmaxtime_getf(int elt_idx)
{
...
__INLINE__ void em_ble_rxmaxtime_setf(int elt_idx, uint16_t rxmaxtime)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_SK_ADDR   (EM_BASE_ADDR + 0x3C + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_SK_ADDR   (0x5000403C + EM_BLE_CS_OFFSET)
#endif
...
__INLINE__ uint16_t em_ble_sk_get(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 7);
    return EM_BLE_RD(EM_BLE_SK_ADDR + elt_idx * REG_EM_BLE_CS_SIZE + reg_idx * 2);
}

__INLINE__ void em_ble_sk_set(int elt_idx, int reg_idx, uint16_t value)
{
    ASSERT_ERR(reg_idx <= 7);
...
__INLINE__ uint16_t em_ble_sk_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 7);
...
__INLINE__ void em_ble_sk_setf(int elt_idx, int reg_idx, uint16_t sk)
{
    ASSERT_ERR(reg_idx <= 7);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_ADV_BD_ADDR_ADDR   (EM_BASE_ADDR + 0x3C + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_ADV_BD_ADDR_ADDR   (0x5000403C + EM_BLE_CS_OFFSET)
#endif
...
__INLINE__ uint16_t em_ble_adv_bd_addr_get(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 2);
    return EM_BLE_RD(EM_BLE_ADV_BD_ADDR_ADDR + elt_idx * REG_EM_BLE_CS_SIZE + reg_idx * 2);
}

__INLINE__ void em_ble_adv_bd_addr_set(int elt_idx, int reg_idx, uint16_t value)
{
    ASSERT_ERR(reg_idx <= 2);
...
__INLINE__ uint16_t em_ble_adv_bd_addr_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 2);
...
__INLINE__ void em_ble_adv_bd_addr_setf(int elt_idx, int reg_idx, uint16_t advbdaddr)
{
    ASSERT_ERR(reg_idx <= 2);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_PEER_RALPTR_ADDR   (EM_BASE_ADDR + 0x3C + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_PEER_RALPTR_ADDR   (0x5000403C + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_PEER_RALPTR_INDEX  0x0000001E
#define EM_BLE_PEER_RALPTR_RESET  0x00000000

__INLINE__ uint16_t em_ble_peer_ralptr_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_PEER_RALPTR_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_peer_ralptr_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_peer_ralptr_getf(int elt_idx)
{
...
__INLINE__ void em_ble_peer_ralptr_setf(int elt_idx, uint16_t peerralptr)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_ADV_BD_ADDR_TYPE_ADDR   (EM_BASE_ADDR + 0x42 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_ADV_BD_ADDR_TYPE_ADDR   (0x50004042 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_ADV_BD_ADDR_TYPE_INDEX  0x00000021
#define EM_BLE_ADV_BD_ADDR_TYPE_RESET  0x00000000

__INLINE__ uint16_t em_ble_adv_bd_addr_type_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_ADV_BD_ADDR_TYPE_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_adv_bd_addr_type_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint8_t em_ble_adv_bd_addr_type_getf(int elt_idx)
{
...
__INLINE__ void em_ble_adv_bd_addr_type_setf(int elt_idx, uint8_t advbdaddrtype)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_AUXTXDESCPTR_ADDR   (EM_BASE_ADDR + 0x44 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_AUXTXDESCPTR_ADDR   (0x50004044 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_AUXTXDESCPTR_INDEX  0x00000022
#define EM_BLE_AUXTXDESCPTR_RESET  0x00000000

__INLINE__ uint16_t em_ble_auxtxdescptr_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_AUXTXDESCPTR_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_auxtxdescptr_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_auxtxdescptr_getf(int elt_idx)
{
...
__INLINE__ void em_ble_auxtxdescptr_setf(int elt_idx, uint16_t auxtxdescptr)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_IV_ADDR   (EM_BASE_ADDR + 0x4C + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_IV_ADDR   (0x5000404C + EM_BLE_CS_OFFSET)
#endif
...
__INLINE__ uint16_t em_ble_iv_get(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 3);
    return EM_BLE_RD(EM_BLE_IV_ADDR + elt_idx * REG_EM_BLE_CS_SIZE + reg_idx * 2);
}

__INLINE__ void em_ble_iv_set(int elt_idx, int reg_idx, uint16_t value)
{
    ASSERT_ERR(reg_idx <= 3);
...
__INLINE__ uint16_t em_ble_iv_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 3);
...
__INLINE__ void em_ble_iv_setf(int elt_idx, int reg_idx, uint16_t iv)
{
    ASSERT_ERR(reg_idx <= 3);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_WINOFFSET_2M_ADDR   (EM_BASE_ADDR + 0x46 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_WINOFFSET_2M_ADDR   (0x50004046 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_WINOFFSET_2M_INDEX  0x00000023
#define EM_BLE_WINOFFSET_2M_RESET  0x00000000

__INLINE__ uint16_t em_ble_winoffset_2m_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_WINOFFSET_2M_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_winoffset_2m_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_winoffset_2m_getf(int elt_idx)
{
...
__INLINE__ void em_ble_winoffset_2m_setf(int elt_idx, uint16_t winoffset2m)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_CONNINTERVAL_2M_ADDR   (EM_BASE_ADDR + 0x48 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_CONNINTERVAL_2M_ADDR   (0x50004048 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_CONNINTERVAL_2M_INDEX  0x00000024
#define EM_BLE_CONNINTERVAL_2M_RESET  0x00000000

__INLINE__ uint16_t em_ble_conninterval_2m_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_CONNINTERVAL_2M_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_conninterval_2m_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_conninterval_2m_getf(int elt_idx)
{
...
__INLINE__ void em_ble_conninterval_2m_setf(int elt_idx, uint16_t conninterval2m)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_WINOFFSET_LR_ADDR   (EM_BASE_ADDR + 0x4A + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_WINOFFSET_LR_ADDR   (0x5000404A + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_WINOFFSET_LR_INDEX  0x00000025
#define EM_BLE_WINOFFSET_LR_RESET  0x00000000

__INLINE__ uint16_t em_ble_winoffset_lr_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_WINOFFSET_LR_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_winoffset_lr_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_winoffset_lr_getf(int elt_idx)
{
...
__INLINE__ void em_ble_winoffset_lr_setf(int elt_idx, uint16_t winoffsetlr)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_CONNINTERVAL_LR_ADDR   (EM_BASE_ADDR + 0x4C + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_CONNINTERVAL_LR_ADDR   (0x5000404C + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_CONNINTERVAL_LR_INDEX  0x00000026
#define EM_BLE_CONNINTERVAL_LR_RESET  0x00000000

__INLINE__ uint16_t em_ble_conninterval_lr_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_CONNINTERVAL_LR_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_conninterval_lr_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_conninterval_lr_getf(int elt_idx)
{
...
__INLINE__ void em_ble_conninterval_lr_setf(int elt_idx, uint16_t connintervallr)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_TXWINOFFSET_ADDR   (EM_BASE_ADDR + 0x54 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_TXWINOFFSET_ADDR   (0x50004054 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_TXWINOFFSET_INDEX  0x0000002A
#define EM_BLE_TXWINOFFSET_RESET  0x00000000

__INLINE__ uint16_t em_ble_txwinoffset_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXWINOFFSET_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_txwinoffset_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_txwinoffset_getf(int elt_idx)
{
...
__INLINE__ void em_ble_txwinoffset_setf(int elt_idx, uint16_t txwinoffset)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_TXCCMPKTCNT0_ADDR   (EM_BASE_ADDR + 0x54 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_TXCCMPKTCNT0_ADDR   (0x50004054 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_TXCCMPKTCNT0_INDEX  0x0000002A
#define EM_BLE_TXCCMPKTCNT0_RESET  0x00000000

__INLINE__ uint16_t em_ble_txccmpktcnt0_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXCCMPKTCNT0_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_txccmpktcnt0_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_txccmpktcnt0_getf(int elt_idx)
{
...
__INLINE__ void em_ble_txccmpktcnt0_setf(int elt_idx, uint16_t txccmpktcnt0)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_EXTADVSTAT_ADDR   (EM_BASE_ADDR + 0x56 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_EXTADVSTAT_ADDR   (0x50004056 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_EXTADVSTAT_INDEX  0x0000002B
#define EM_BLE_EXTADVSTAT_RESET  0x00000000

__INLINE__ uint16_t em_ble_extadvstat_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_EXTADVSTAT_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_extadvstat_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_extadvstat_pack(int elt_idx, uint8_t prevcte, uint8_t prevpam, uint8_t prevlam, uint8_t prevadvmode, uint8_t prevadvpkttype)
{
...
__INLINE__ void em_ble_extadvstat_unpack(int elt_idx, uint8_t* prevcte, uint8_t* prevpam, uint8_t* prevlam, uint8_t* prevadvmode, uint8_t* prevadvpkttype)
{
...
__INLINE__ uint8_t em_ble_extadvstat_prev_cte_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_EXTADVSTAT_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000080)) >> 7);
}

__INLINE__ void em_ble_extadvstat_prev_cte_setf(int elt_idx, uint8_t prevcte)
{
    ASSERT_ERR((((uint16_t)prevcte << 7) & ~((uint16_t)0x00000080)) == 0);
...
__INLINE__ uint8_t em_ble_extadvstat_prev_pam_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_EXTADVSTAT_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000040)) >> 6);
}

__INLINE__ void em_ble_extadvstat_prev_pam_setf(int elt_idx, uint8_t prevpam)
{
    ASSERT_ERR((((uint16_t)prevpam << 6) & ~((uint16_t)0x00000040)) == 0);
...
__INLINE__ uint8_t em_ble_extadvstat_prev_lam_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_EXTADVSTAT_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000020)) >> 5);
}

__INLINE__ void em_ble_extadvstat_prev_lam_setf(int elt_idx, uint8_t prevlam)
{
    ASSERT_ERR((((uint16_t)prevlam << 5) & ~((uint16_t)0x00000020)) == 0);
...
__INLINE__ uint8_t em_ble_extadvstat_prev_adv_mode_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_EXTADVSTAT_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000018)) >> 3);
}

__INLINE__ void em_ble_extadvstat_prev_adv_mode_setf(int elt_idx, uint8_t prevadvmode)
{
    ASSERT_ERR((((uint16_t)prevadvmode << 3) & ~((uint16_t)0x00000018)) == 0);
...
__INLINE__ uint8_t em_ble_extadvstat_prev_adv_pkt_type_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_EXTADVSTAT_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000007)) >> 0);
}

__INLINE__ void em_ble_extadvstat_prev_adv_pkt_type_setf(int elt_idx, uint8_t prevadvpkttype)
{
    ASSERT_ERR((((uint16_t)prevadvpkttype << 0) & ~((uint16_t)0x00000007)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_TXCCMPKTCNT1_ADDR   (EM_BASE_ADDR + 0x56 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_TXCCMPKTCNT1_ADDR   (0x50004056 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_TXCCMPKTCNT1_INDEX  0x0000002B
#define EM_BLE_TXCCMPKTCNT1_RESET  0x00000000

__INLINE__ uint16_t em_ble_txccmpktcnt1_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXCCMPKTCNT1_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_txccmpktcnt1_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_txccmpktcnt1_getf(int elt_idx)
{
...
__INLINE__ void em_ble_txccmpktcnt1_setf(int elt_idx, uint16_t txccmpktcnt1)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_TXCCMPKTCNT2_ADDR   (EM_BASE_ADDR + 0x58 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_TXCCMPKTCNT2_ADDR   (0x50004058 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_TXCCMPKTCNT2_INDEX  0x0000002C
#define EM_BLE_TXCCMPKTCNT2_RESET  0x00000000

__INLINE__ uint16_t em_ble_txccmpktcnt2_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXCCMPKTCNT2_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_txccmpktcnt2_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint8_t em_ble_txccmpktcnt2_getf(int elt_idx)
{
...
__INLINE__ void em_ble_txccmpktcnt2_setf(int elt_idx, uint8_t txccmpktcnt2)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXCCMPKTCNT0_ADDR   (EM_BASE_ADDR + 0x5A + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_RXCCMPKTCNT0_ADDR   (0x5000405A + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_RXCCMPKTCNT0_INDEX  0x0000002D
#define EM_BLE_RXCCMPKTCNT0_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxccmpktcnt0_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXCCMPKTCNT0_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_rxccmpktcnt0_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_rxccmpktcnt0_getf(int elt_idx)
{
...
__INLINE__ void em_ble_rxccmpktcnt0_setf(int elt_idx, uint16_t rxccmpktcnt0)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXCCMPKTCNT1_ADDR   (EM_BASE_ADDR + 0x5C + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_RXCCMPKTCNT1_ADDR   (0x5000405C + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_RXCCMPKTCNT1_INDEX  0x0000002E
#define EM_BLE_RXCCMPKTCNT1_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxccmpktcnt1_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXCCMPKTCNT1_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_rxccmpktcnt1_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_rxccmpktcnt1_getf(int elt_idx)
{
...
__INLINE__ void em_ble_rxccmpktcnt1_setf(int elt_idx, uint16_t rxccmpktcnt1)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_RXCCMPKTCNT2_ADDR   (EM_BASE_ADDR + 0x5E + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_RXCCMPKTCNT2_ADDR   (0x5000405E + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_RXCCMPKTCNT2_INDEX  0x0000002F
#define EM_BLE_RXCCMPKTCNT2_RESET  0x00000000

__INLINE__ uint16_t em_ble_rxccmpktcnt2_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXCCMPKTCNT2_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_rxccmpktcnt2_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint8_t em_ble_rxccmpktcnt2_getf(int elt_idx)
{
...
__INLINE__ void em_ble_rxccmpktcnt2_setf(int elt_idx, uint8_t rxccmpktcnt2)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_EVTCNT_ADDR   (EM_BASE_ADDR + 0x60 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_EVTCNT_ADDR   (0x50004060 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_EVTCNT_INDEX  0x00000030
#define EM_BLE_EVTCNT_RESET  0x00000000

__INLINE__ uint16_t em_ble_evtcnt_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_EVTCNT_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_evtcnt_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_evtcnt_getf(int elt_idx)
{
...
__INLINE__ void em_ble_evtcnt_setf(int elt_idx, uint16_t evtcnt)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_EVTCNT_OFFSET0_ADDR   (EM_BASE_ADDR + 0x62 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_EVTCNT_OFFSET0_ADDR   (0x50004062 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_EVTCNT_OFFSET0_INDEX  0x00000031
#define EM_BLE_EVTCNT_OFFSET0_RESET  0x00000000

__INLINE__ uint16_t em_ble_evtcnt_offset0_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_EVTCNT_OFFSET0_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_evtcnt_offset0_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_evtcnt_offset0_getf(int elt_idx)
{
...
__INLINE__ void em_ble_evtcnt_offset0_setf(int elt_idx, uint16_t evtcntoffset0)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_EVTCNT_OFFSET1_ADDR   (EM_BASE_ADDR + 0x64 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_EVTCNT_OFFSET1_ADDR   (0x50004064 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_EVTCNT_OFFSET1_INDEX  0x00000032
#define EM_BLE_EVTCNT_OFFSET1_RESET  0x00000000

__INLINE__ uint16_t em_ble_evtcnt_offset1_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_EVTCNT_OFFSET1_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_evtcnt_offset1_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint16_t em_ble_evtcnt_offset1_getf(int elt_idx)
{
...
__INLINE__ void em_ble_evtcnt_offset1_setf(int elt_idx, uint16_t evtcntoffset1)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_EVTCNT_OFFSET2_ADDR   (EM_BASE_ADDR + 0x66 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_EVTCNT_OFFSET2_ADDR   (0x50004066 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_EVTCNT_OFFSET2_INDEX  0x00000033
#define EM_BLE_EVTCNT_OFFSET2_RESET  0x00000000

__INLINE__ uint16_t em_ble_evtcnt_offset2_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_EVTCNT_OFFSET2_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_evtcnt_offset2_set(int elt_idx, uint16_t value)
{
...
__INLINE__ uint8_t em_ble_evtcnt_offset2_getf(int elt_idx)
{
...
__INLINE__ void em_ble_evtcnt_offset2_setf(int elt_idx, uint8_t evtcntoffset2)
{
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_ISOEVTCNTL_ADDR   (EM_BASE_ADDR + 0x68 + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_ISOEVTCNTL_ADDR   (0x50004068 + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_ISOEVTCNTL_INDEX  0x00000034
#define EM_BLE_ISOEVTCNTL_RESET  0x00000000

__INLINE__ uint16_t em_ble_isoevtcntl_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_ISOEVTCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_isoevtcntl_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_isoevtcntl_pack(int elt_idx, uint8_t flushcnt, uint8_t subevtcnt)
{
...
__INLINE__ void em_ble_isoevtcntl_unpack(int elt_idx, uint8_t* flushcnt, uint8_t* subevtcnt)
{
...
__INLINE__ uint8_t em_ble_isoevtcntl_flushcnt_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_ISOEVTCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000FF00)) >> 8);
}

__INLINE__ void em_ble_isoevtcntl_flushcnt_setf(int elt_idx, uint8_t flushcnt)
{
    ASSERT_ERR((((uint16_t)flushcnt << 8) & ~((uint16_t)0x0000FF00)) == 0);
...
__INLINE__ uint8_t em_ble_isoevtcntl_subevtcnt_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_ISOEVTCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x000000FF)) >> 0);
}

__INLINE__ void em_ble_isoevtcntl_subevtcnt_setf(int elt_idx, uint8_t subevtcnt)
{
    ASSERT_ERR((((uint16_t)subevtcnt << 0) & ~((uint16_t)0x000000FF)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_ISOTXRXCNTL_ADDR   (EM_BASE_ADDR + 0x6A + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_ISOTXRXCNTL_ADDR   (0x5000406A + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_ISOTXRXCNTL_INDEX  0x00000035
#define EM_BLE_ISOTXRXCNTL_RESET  0x00000000

__INLINE__ uint16_t em_ble_isotxrxcntl_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
}

__INLINE__ void em_ble_isotxrxcntl_set(int elt_idx, uint16_t value)
{
...
__INLINE__ void em_ble_isotxrxcntl_pack(int elt_idx, uint8_t isorxbufffull, uint8_t isolastempty, uint8_t isomd, uint8_t isosn, uint8_t isonesn, uint8_t isoretx, uint8_t isorsvd, uint8_t isowaitack, uint8_t isolastmd, uint8_t isolastnesn, uint8_t isolastsn)
{
...
__INLINE__ void em_ble_isotxrxcntl_unpack(int elt_idx, uint8_t* isorxbufffull, uint8_t* isolastempty, uint8_t* isomd, uint8_t* isosn, uint8_t* isonesn, uint8_t* isoretx, uint8_t* isorsvd, uint8_t* isowaitack, uint8_t* isolastmd, uint8_t* isolastnesn, uint8_t* isolastsn)
{
...
__INLINE__ uint8_t em_ble_isotxrxcntl_isorxbuff_full_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__INLINE__ void em_ble_isotxrxcntl_isorxbuff_full_setf(int elt_idx, uint8_t isorxbufffull)
{
    ASSERT_ERR((((uint16_t)isorxbufffull << 15) & ~((uint16_t)0x00008000)) == 0);
...
__INLINE__ uint8_t em_ble_isotxrxcntl_isolastempty_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00004000)) >> 14);
}

__INLINE__ void em_ble_isotxrxcntl_isolastempty_setf(int elt_idx, uint8_t isolastempty)
{
    ASSERT_ERR((((uint16_t)isolastempty << 14) & ~((uint16_t)0x00004000)) == 0);
...
__INLINE__ uint8_t em_ble_isotxrxcntl_isomd_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00002000)) >> 13);
}

__INLINE__ void em_ble_isotxrxcntl_isomd_setf(int elt_idx, uint8_t isomd)
{
    ASSERT_ERR((((uint16_t)isomd << 13) & ~((uint16_t)0x00002000)) == 0);
...
__INLINE__ uint8_t em_ble_isotxrxcntl_isosn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00001000)) >> 12);
}

__INLINE__ void em_ble_isotxrxcntl_isosn_setf(int elt_idx, uint8_t isosn)
{
    ASSERT_ERR((((uint16_t)isosn << 12) & ~((uint16_t)0x00001000)) == 0);
...
__INLINE__ uint8_t em_ble_isotxrxcntl_isonesn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000800)) >> 11);
}

__INLINE__ void em_ble_isotxrxcntl_isonesn_setf(int elt_idx, uint8_t isonesn)
{
    ASSERT_ERR((((uint16_t)isonesn << 11) & ~((uint16_t)0x00000800)) == 0);
...
__INLINE__ uint8_t em_ble_isotxrxcntl_isoretx_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000200)) >> 9);
}

__INLINE__ void em_ble_isotxrxcntl_isoretx_setf(int elt_idx, uint8_t isoretx)
{
    ASSERT_ERR((((uint16_t)isoretx << 9) & ~((uint16_t)0x00000200)) == 0);
...
__INLINE__ uint8_t em_ble_isotxrxcntl_isorsvd_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000100)) >> 8);
}

__INLINE__ void em_ble_isotxrxcntl_isorsvd_setf(int elt_idx, uint8_t isorsvd)
{
    ASSERT_ERR((((uint16_t)isorsvd << 8) & ~((uint16_t)0x00000100)) == 0);
...
__INLINE__ uint8_t em_ble_isotxrxcntl_isowaitack_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000008)) >> 3);
}

__INLINE__ void em_ble_isotxrxcntl_isowaitack_setf(int elt_idx, uint8_t isowaitack)
{
    ASSERT_ERR((((uint16_t)isowaitack << 3) & ~((uint16_t)0x00000008)) == 0);
...
__INLINE__ uint8_t em_ble_isotxrxcntl_isolastmd_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000004)) >> 2);
}

__INLINE__ void em_ble_isotxrxcntl_isolastmd_setf(int elt_idx, uint8_t isolastmd)
{
    ASSERT_ERR((((uint16_t)isolastmd << 2) & ~((uint16_t)0x00000004)) == 0);
...
__INLINE__ uint8_t em_ble_isotxrxcntl_isolastnesn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000002)) >> 1);
}

__INLINE__ void em_ble_isotxrxcntl_isolastnesn_setf(int elt_idx, uint8_t isolastnesn)
{
    ASSERT_ERR((((uint16_t)isolastnesn << 1) & ~((uint16_t)0x00000002)) == 0);
...
__INLINE__ uint8_t em_ble_isotxrxcntl_isolastsn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000001)) >> 0);
}

__INLINE__ void em_ble_isotxrxcntl_isolastsn_setf(int elt_idx, uint8_t isolastsn)
{
    ASSERT_ERR((((uint16_t)isolastsn << 0) & ~((uint16_t)0x00000001)) == 0);
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_TXRXDESCCNT_ADDR   (EM_BASE_ADDR + 0x6C + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_TXRXDESCCNT_ADDR   (0x5000406C + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_TXRXDESCCNT_INDEX  0x00000036
#define EM_BLE_TXRXDESCCNT_RESET  0x00000000

__INLINE__ uint16_t em_ble_txrxdesccnt_get(int elt_idx)
{
...
__INLINE__ void em_ble_txrxdesccnt_unpack(int elt_idx, uint8_t* aclrxdesccnt, uint8_t* acltxdesccnt)
{
...
__INLINE__ uint8_t em_ble_txrxdesccnt_aclrxdesccnt_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXRXDESCCNT_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000FF00)) >> 8);
}

__INLINE__ uint8_t em_ble_txrxdesccnt_acltxdesccnt_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXRXDESCCNT_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x000000FF)) >> 0);
}
 ...
 */
#if (EM_ADDR_USE_MACRO)
#define EM_BLE_ISOTXRXPKTCNT_ADDR   (EM_BASE_ADDR + 0x6E + EM_BLE_CS_OFFSET)
#else
#define EM_BLE_ISOTXRXPKTCNT_ADDR   (0x5000406E + EM_BLE_CS_OFFSET)
#endif

#define EM_BLE_ISOTXRXPKTCNT_INDEX  0x00000037
#define EM_BLE_ISOTXRXPKTCNT_RESET  0x00000000

__INLINE__ uint16_t em_ble_isotxrxpktcnt_get(int elt_idx)
{
...
__INLINE__ void em_ble_isotxrxpktcnt_unpack(int elt_idx, uint8_t* isorxpktcntl, uint8_t* isotxpktcntl)
{
...
__INLINE__ uint8_t em_ble_isotxrxpktcnt_isorxpktcntl_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_ISOTXRXPKTCNT_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000FF00)) >> 8);
}

__INLINE__ uint8_t em_ble_isotxrxpktcnt_isotxpktcntl_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_ISOTXRXPKTCNT_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x000000FF)) >> 0);
}
