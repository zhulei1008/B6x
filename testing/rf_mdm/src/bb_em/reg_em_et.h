 ...
 * </pre>
 */
#define EM_BT_EXTAB_ADDR   (EM_ET_BASE_ADDR + 0x00)
 ...
 * </pre>
 */
#define EM_LE_EXTAB_ADDR   (EM_ET_BASE_ADDR + 0x00)
...
__INLINE__ void em_le_extab_pack(int elt_idx, uint8_t schprio1, uint8_t spa, uint8_t aenps, uint8_t rsvd, uint8_t iso, uint8_t status, uint8_t mode)
{
    ASSERT_ERR((((uint16_t)schprio1 << 11) & ~((uint16_t)0x0000F800)) == 0);
    ASSERT_ERR((((uint16_t)spa << 10) & ~((uint16_t)0x00000400)) == 0);
 ...
 * </pre>
 */
#define EM_RAWSTP0_ADDR   (EM_ET_BASE_ADDR + 0x02)
 ...
 * </pre>
 */
#define EM_RAWSTP1_ADDR   (EM_ET_BASE_ADDR + 0x04)
 ...
 * </pre>
 */
#define EM_FINESTP_ADDR   (EM_ET_BASE_ADDR + 0x06)
 ...
 * </pre>
 */
#define EM_CSPTR_ADDR   (EM_ET_BASE_ADDR + 0x08)
 ...
 * </pre>
 */
#define EM_PRIOBW_ADDR   (EM_ET_BASE_ADDR + 0x0A)
 ...
 * </pre>
 */
#define EM_PRIOLVL_ADDR   (EM_ET_BASE_ADDR + 0x0C)
 ...
 * </pre>
 */
#define EM_PTI_VXCHAN_ADDR   (EM_ET_BASE_ADDR + 0x0E)
