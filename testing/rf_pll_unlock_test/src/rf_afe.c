...
//    RF->RSSI_CTRL.SW_RSSI_REQ            = 0; // rw, bit17
    ...
    // 0x10, Read Write
    RF->PLL_DAC_TAB0.PLL_DAC_ADJ00         = 0x0F;
    RF->PLL_DAC_TAB0.PLL_DAC_ADJ01         = 0x0F;
    RF->PLL_DAC_TAB0.PLL_DAC_ADJ02         = 0x0F;
    RF->PLL_DAC_TAB0.PLL_DAC_ADJ03         = 0x0F;
    RF->PLL_DAC_TAB0.PLL_DAC_ADJ04         = 0x0F;
...
//    RF->PLL_GAIN_CAL_VAL.PLL_CAL_STATE;
    ...
    // 0x30, Read Write
    RF->PLL_DAC_TAB1.PLL_DAC_ADJ10       = 0x0F;
    RF->PLL_DAC_TAB1.PLL_DAC_ADJ11       = 0x0F;
    RF->PLL_DAC_TAB1.PLL_DAC_ADJ12       = 0x0F;
    RF->PLL_DAC_TAB1.PLL_DAC_ADJ13       = 0x0F;
    RF->PLL_DAC_TAB1.PLL_DAC_ADJ14       = 0x0F;
    
    // 0x34, Read Write
    RF->PLL_DAC_TAB2.PLL_DAC_ADJ05       = 0x0F;
    RF->PLL_DAC_TAB2.PLL_DAC_ADJ15       = 0x0F;
    ...
    RF->BPFMIX_CTRL.BPF_CAL_CODE_EXT     = 0x26;//0x1A;
    ...
    RF->AGC_CTRL0.DISABLE_AGC            = 0;    // bit28
    ...
    RF->ANA_TRIM.BG_RES_TRIM             = 0x1F;//0x1F; //LDO_RX_TRIM = 4时, BG_RES_TRIM=0x17,VDD_IF:1.28V对应VBG1.2V
    RF->ANA_TRIM.BG_VREF_FINE            = 6;
    RF->ANA_TRIM.LDO_RX_TRIM             = 4;
    RF->ANA_TRIM.LDO_TX_TRIM             = 4;
    RF->ANA_TRIM.LNA_RES_TRIM            = 2;//4;
    RF->ANA_TRIM.BPF_GAIN_ADJ            = 3;
    RF->ANA_TRIM.MIXL_GAIN_CTL           = 0;
    RF->ANA_TRIM.MIXH_GAIN_CTL           = 1;//0; //QFN32-22, SNR29.7
    ...
    // 0x70, Read Write
    // bit[14:11] = 7, bit15:CLK_128M_DAC enable
...
// 2023.06.24 
// 用于FT时生成PLL_DAC_TAB
uint8_t get_gain_cal_st(uint8_t chan_num)
{
    RF->DIG_CTRL.PLL_FREQ_SEL            = 0;
    RF->PLL_ANA_CTRL.PLL_VCTRL_EXT_EN    = 0;
    RF->DIG_CTRL.PLL_GAIN_CAL_BY         = 0;
...
void tx_sw_channel_num_test(uint8_t chan_num)
{
...
void rx_sw_channel_num_test(uint8_t chan_num)
{
...
//    RF->PLL_FREQ_CTRL.SW_PLL_FRAC        = 8;  
//    RF->PLL_FREQ_CTRL.SW_PLL_DI_S        = 0x06; //rx2440M
    RF->PLL_DYM_CTRL.SW_RX_EN            = 1;
...
//    while (1)
//    {
//        if (RF->RF_ANA_ST0.PLL_LOCK)
//        {
//            RF->PLL_DYM_CTRL.SW_TX_EN         = 0; // soft cfg en
//            btmr_delay(16, 2000); //unit:us
//            RF->PLL_DYM_CTRL.SW_TX_EN         = 1; // soft cfg en
//            btmr_delay(16, 4000);
//        }
//    }
...
uint8_t pll_rx_unlock_test(uint8_t pll_dis, uint8_t pll_frach)
{
    RF->PLL_DYM_CTRL.SW_RX_EN         = 0;
    btmr_delay(16, 200);
...
//    pll_rx_1m_lock_test_cmd(5, 0);// Rx--2144MHz
    rx_sw_channel_num_test(17); //2440MHz
    ...
    return RF->RF_ANA_ST0.BPF_CAL_CODE;
}
