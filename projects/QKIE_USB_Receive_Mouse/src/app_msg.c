...
static uint32_t init_time_cnt_max = 0;
enum app_custom_msg_id
{
    APP_INIT_TIMER = APP_BASE_MSG + 3,
//    APP_10SEC_TIMER = APP_BASE_MSG+4,
};
...
//    else if(msgid==APP_10SEC_TIMER)
//    {
//        ke_timer_set(APP_10SEC_TIMER, TASK_APP, 10000);
//    }
    else 
    #endif
    {
