...
#define CONSUMER_IN_EP            (0x81 + ENB_KEYBD)
#define MOUSE_IN_EP               (0x81 + ENB_KEYBD + ENB_CONSUMER)

#define HID_INST_CNT              ((ENB_KEYBD) + (ENB_CONSUMER) + (ENB_MOUSE))
