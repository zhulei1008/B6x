...
/// Enable of Activities(adv/scan/init)
...
/// Enable Pairing and Bond, used debugLTK
...
enum app_msg_id
{
    ...
    APP_TIME_FIRST_UPADTA_PAR,
    APP_TIMER_10MINUTES,
    HOGPD_WAKEUP_REPORT,
    APP_DISCONNECT_TIME,
    APP_TIMER_OFF_LED,
    LED_PLAY_LINK,
	APP_TIMER_LOWBAT_ALARM,
};
...
extern struct actv_env_tag actv_env;
