...
//		{
//			uint16_t lpret = core_sleep(CFG_WKUP_BLE_EN|CFG_WKUP_IO_EN);
//			
...
//		if(ble_sleep(BLE_SLP_TWOSC, BLE_SLP_DURMAX)==BLE_IN_SLEEP)
//		{
//			core_sleep(CFG_WKUP_BLE_EN/*|WKUP_PWIO_EN_BIT*/);
//			kb_scan();
//		}
//		
//	}

    if ((slpdur > 320) && (ble_sleep(BLE_SLP_TWOSC, BLE_SLP_DURMAX) == BLE_IN_SLEEP))
    {
        uint16_t core_wkup_en = (slpdur < 1600) ? (CFG_WKUP_BLE_EN) : (CFG_WKUP_BLE_EN | CFG_WKUP_IO_EN);
