...
/* User customize */
#if (ROLE_BURNER)
#define LED0_IO  PIN_OK_LED    //GREEN HIGH
#define LED1_IO  PIN_FAIL_LED  //RED   HIGH
#define LED2_IO  PIN_BUSY_LED  //BLUE  LOW
...
#else
    {LED(2) | LED(0) | LED(1), OFF(2) | OFF(0) | OFF(1), _MS(200)},
    {LED(2),               ON(2),                _MS(200)},
#endif
};
...
#if (ROLE_BATCH)
#define LED0_IO  PIN_OK_LED     //BLUE  HIGH
#define LED1_IO  PIN_FAIL_LED   //RED   HIGH

const led_item_t LED_READY_ITEM[] =
{
    {LED(0) | LED(1), ON(0) | OFF(1),  _MS(200) },
    {LED(0),        OFF(0),        _MS(1000)},
};

const led_item_t LED_ERROR_ITEM[] =
{
    {LED(0) | LED(1), OFF(0) | ON(1),  _MS(500)},
    {LED(1),        OFF(1),        _MS(500)},
};
...
const led_item_t LED_OK_ITEM[] =
{
    {LED(0) | LED(1), ON(0) | OFF(1),  _MS(0)},
};

const led_item_t LED_FAIL_ITEM[] =
{
    {LED(0) | LED(1), OFF(0) | ON(1),  _MS(0)},
};

const led_item_t LED_OFF_ITEM[] =
{
    {LED(0) | LED(1), OFF(0) | OFF(1), _MS(0)},
};
#endif
